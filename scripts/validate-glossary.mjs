...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 317, "Les définitions courtes uniques doivent être au nombre de 317 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 42, shortNoindex: 317, mergedAliases: 6 }));
