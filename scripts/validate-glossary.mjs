...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 341, "Les définitions courtes uniques doivent être au nombre de 341 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 330, mergedAliases: 6 }));
