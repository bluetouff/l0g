...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 411, "Les définitions courtes uniques doivent être au nombre de 411 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 411, mergedAliases: 6 }));
