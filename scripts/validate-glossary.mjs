...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 381, "Les définitions courtes uniques doivent être au nombre de 381 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 381, mergedAliases: 6 }));
