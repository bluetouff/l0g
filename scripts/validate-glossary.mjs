...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 421, "Les définitions courtes uniques doivent être au nombre de 421 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 421, mergedAliases: 6 }));
