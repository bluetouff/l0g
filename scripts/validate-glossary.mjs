...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 391, "Les définitions courtes uniques doivent être au nombre de 391 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 391, mergedAliases: 6 }));
