...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 371, "Les définitions courtes uniques doivent être au nombre de 371 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 335, mergedAliases: 6 }));
