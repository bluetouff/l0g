...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 414, "Les définitions courtes uniques doivent être au nombre de 414 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 414, mergedAliases: 6 }));
