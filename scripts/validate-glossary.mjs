...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 324, "Les définitions courtes uniques doivent être au nombre de 324 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 42, shortNoindex: 324, mergedAliases: 6 }));
