...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 300, 'Les définitions courtes uniques doivent être au nombre de 300 après fusion');
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 42, shortNoindex: 300, mergedAliases: 6 }));
