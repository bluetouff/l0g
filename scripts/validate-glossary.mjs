...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 423, "Les définitions courtes uniques doivent être au nombre de 423 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 423, mergedAliases: 6 }));
