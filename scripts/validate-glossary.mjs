...
assert.equal(glossaryEntries.length, 512, 'Le corpus doit conserver ses 512 définitions uniques');
assert.equal(glossaryAtlasEntries.length, 63, 'Le graphe Atlas doit conserver ses 63 nœuds');
