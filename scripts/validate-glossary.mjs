...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 387, "Les définitions courtes uniques doivent être au nombre de 387 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 387, mergedAliases: 6 }));
