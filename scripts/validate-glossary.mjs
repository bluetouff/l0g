...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 382, "Les définitions courtes uniques doivent être au nombre de 382 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 382, mergedAliases: 6 }));
