...
assert.equal(glossaryEntries.length, 504, 'Le corpus doit conserver ses 504 définitions uniques');
assert.equal(glossaryAtlasEntries.length, 55, 'Le graphe Atlas doit conserver ses 55 nœuds');
