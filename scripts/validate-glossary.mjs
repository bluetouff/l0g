...
assert.equal(glossaryEntries.length, 548, 'Le corpus doit conserver ses 548 définitions uniques');
assert.equal(glossaryAtlasEntries.length, 102, 'Le graphe Atlas doit conserver ses 102 nœuds');
assert.equal(glossaryAtlasEdgeCount, 401, 'Le graphe Atlas doit conserver ses 401 relations');
