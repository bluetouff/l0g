...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 374, "Les définitions courtes uniques doivent être au nombre de 374 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 374, mergedAliases: 6 }));
