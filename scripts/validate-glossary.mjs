...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 422, "Les définitions courtes uniques doivent être au nombre de 422 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 422, mergedAliases: 6 }));
