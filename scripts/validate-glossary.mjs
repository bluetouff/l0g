...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 388, "Les définitions courtes uniques doivent être au nombre de 388 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 388, mergedAliases: 6 }));
