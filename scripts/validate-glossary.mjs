...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 417, "Les définitions courtes uniques doivent être au nombre de 417 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 417, mergedAliases: 6 }));
