...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 322, "Les définitions courtes uniques doivent être au nombre de 322 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 42, shortNoindex: 322, mergedAliases: 6 }));
