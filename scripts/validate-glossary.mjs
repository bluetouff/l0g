...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 392, "Les définitions courtes uniques doivent être au nombre de 392 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 392, mergedAliases: 6 }));
