...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 404, "Les définitions courtes uniques doivent être au nombre de 404 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 404, mergedAliases: 6 }));
