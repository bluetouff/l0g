...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 326, "Les définitions courtes uniques doivent être au nombre de 326 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 42, shortNoindex: 326, mergedAliases: 6 }));
