...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 379, "Les définitions courtes uniques doivent être au nombre de 379 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 379, mergedAliases: 6 }));
