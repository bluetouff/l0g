...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 383, "Les définitions courtes uniques doivent être au nombre de 383 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 383, mergedAliases: 6 }));
