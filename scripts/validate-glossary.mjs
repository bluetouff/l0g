...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 305, 'Les définitions courtes uniques doivent être au nombre de 305 après fusion');
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 42, shortNoindex: 305, mergedAliases: 6 }));
