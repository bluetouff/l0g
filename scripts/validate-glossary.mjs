...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 400, "Les définitions courtes uniques doivent être au nombre de 400 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 400, mergedAliases: 6 }));
