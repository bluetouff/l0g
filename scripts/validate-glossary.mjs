...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 380, "Les définitions courtes uniques doivent être au nombre de 380 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 380, mergedAliases: 6 }));
