...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 376, "Les définitions courtes uniques doivent être au nombre de 376 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 376, mergedAliases: 6 }));
