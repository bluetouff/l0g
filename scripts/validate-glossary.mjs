...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 386, "Les définitions courtes uniques doivent être au nombre de 386 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 386, mergedAliases: 6 }));
