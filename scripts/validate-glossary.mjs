...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 390, "Les définitions courtes uniques doivent être au nombre de 390 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 50, shortNoindex: 390, mergedAliases: 6 }));
