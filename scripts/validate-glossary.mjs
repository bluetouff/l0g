...
assert.equal(glossaryEntries.length - glossaryAtlasEntries.length, 310, "Les définitions courtes uniques doivent être au nombre de 310 après fusion");
...
console.log(JSON.stringify({ ok: true, atlasIndexed: 42, shortNoindex: 310, mergedAliases: 6 }));
