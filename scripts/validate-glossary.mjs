...
assert.equal(glossaryEntries.length, 518, 'Le corpus doit conserver ses 518 définitions uniques');
assert.equal(glossaryAtlasEntries.length, 70, 'Le graphe Atlas doit conserver ses 70 nœuds');
