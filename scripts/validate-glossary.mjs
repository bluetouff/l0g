...
assert.equal(glossaryEntries.length, 516, 'Le corpus doit conserver ses 516 définitions uniques');
assert.equal(glossaryAtlasEntries.length, 68, 'Le graphe Atlas doit conserver ses 68 nœuds');
