...
| [`MODELES-RISQUE.md`](MODELES-RISQUE.md) | conventions des modèles et lecture des scores | aligné avec `/methodologie/` et la version Agent Surface définie dans `src/config/agent-contract.mjs` |
