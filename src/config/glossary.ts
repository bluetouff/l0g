...
const rawGlossarySections: GlossarySourceSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { sigle: 'LME', nom: 'Liability management exercise', def: "Restructuration négociée de la dette d'une entreprise en difficulté, hors défaut formel : échange de titres, extension de maturité, apport de collatéral. Repousse le défaut, mais lèse souvent une partie des créanciers. En 2025-2026, les LME représentent l'essentiel de l'activité de défaut, masquant un stress que le taux de défaut classique sous-estime.", guide: '/guides/lire-les-clo-et-prets-a-effet-de-levier/' },
