...
const rawGlossarySections: GlossarySourceSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { sigle: 'Valeur résiduelle', nom: 'Residual value', def: "Valeur attendue d'un actif à l'échéance du financement qui l'a porté. Elle comble l'écart entre la durée d'un prêt et celle des contrats qui le remboursent. Vérifiable sur un avion ou un immeuble grâce à des séries de transactions comparables, elle repose sur des estimations divergentes pour un accélérateur de calcul.", guide: '/posts/gpu-collateral-ce-que-le-preteur-recupere/' },
