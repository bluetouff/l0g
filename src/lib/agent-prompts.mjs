...
export const agentPrompts = Object.freeze([
  Object.freeze({
    ...
    instructions: ({ language }) => [
      ...
      'Sépare explicitement faits revus, estimations, inférences, scénarios et assertions non classées.',
  ...
  Object.freeze({
    ...
    instructions: ({ language }) => [
      ...
      'Distingue preuve directe, contenu seulement relié, estimation, inférence, scénario et assertion non classée.',
