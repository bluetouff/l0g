      ...
      schemas: {
        ...
        MethodologySummary: {
          ...
          properties: {
            ...
            updated: { type: 'string' },
            scaleCaveat: { type: ['object', 'null'], additionalProperties: true },
        ...
        AgentManifest: {
          ...
          properties: {
            ...
            proofPolicy: { type: 'object', additionalProperties: true },
          },
        },
        Catalog: {
          type: 'object',
          ...
          properties: {
            ...
            glossaryCategories: { type: 'array', items: { type: 'object', additionalProperties: true } },
            primarySources: { type: 'array', items: { $ref: '#/components/schemas/PrimarySource' } },
            editorial: { type: 'object', additionalProperties: true },
            riskBandScaleCaveat: { type: 'object', additionalProperties: true },
          },
        },
        ClaimsSurface: {
          type: 'object',
        ...
        RiskSnapshot: {
          ...
          properties: {
            ...
            confluence: { type: 'object', additionalProperties: true },
            feed: { type: 'string', format: 'uri' },
            note: { type: 'string' },
            precisionGuard: { type: 'object', additionalProperties: true },
            scaleCaveat: { type: 'object', additionalProperties: true },
            license: { type: 'string' },
            attribution: { type: 'string' },
          },
        },
