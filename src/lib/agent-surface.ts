...
export function buildOpenApiContract() {
  ...
  return {
    ...
    paths: {
      ...
      '/api/v1/human-traffic.json': openApiEndpoint('Lectures humaines HTML', 'GET HTML humains agrégés par jour, page et domaine référent, sans identifiant persistant et avec seuil k=5.', 'HumanTrafficSurface'),
    ...
    components: {
      schemas: {
        ...
        HumanTrafficSurface: {
          type: 'object',
          required: ['schema_version', 'generated_at', 'retention_days', 'minimum_public_cohort', 'measurement', 'totals', 'daily', 'limitations'],
          additionalProperties: false,
          properties: {
