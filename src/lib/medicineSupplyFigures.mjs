...
export function medicineFigureSvg(lang='fr',kind='chain',mobile=false){
 ...
 if(kind==='commitments'){
  ...
  b+=lines(x,mobile?1071:665,fr?(mobile?['Source : Commission européenne.','8 septembre 2026.','Engagements annoncés.']:['Source : Commission européenne, 8 septembre 2026. Engagements annoncés, pas bilan d’exécution.']):(mobile?['Source: European Commission.','8 September 2026.','Announced commitments.']:['Source: European Commission, 8 September 2026. Announced commitments, not completed results.']),mobile?14:15,C.muted,18);
