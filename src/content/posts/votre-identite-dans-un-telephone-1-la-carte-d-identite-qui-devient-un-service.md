---
title: "Votre identité dans un téléphone, 1/8 : la carte d’identité qui devient un service"
seoTitle: "France Identité : votre carte d’identité devient un service | l0g"
ogTitle: "Votre carte d’identité devient un service"
description: "France Identité revendique plus de 4,5 millions d’utilisateurs. Enquête sur les données, les serveurs et les traces de l’identité numérique."
...
tags: ["France Identité", "identité numérique", "eIDAS", "EUDI Wallet", "vie privée", "CNIL", "ANSSI", "France Titres", "données personnelles", "enquête"]
draft: false
quickTake:
  fact: "France Titres revendique plus de 4,5 millions d’utilisateurs. Depuis le 24 juin 2026, l’application peut être présentée pour l’enregistrement des bagages et l’embarquement dans les aéroports français."
  importance: "Une carte d’identité numérique n’est pas une simple image : chaque preuve devient une transaction logicielle entre un titre, un téléphone, des serveurs et un destinataire."
  uncertainty: "Les documents publics convergent sur la suppression rapide des attributs d’identité, mais divergent sur le périmètre exact des données serveur, les durées et le contenu des journaux."
---
...
1. la nouvelle carte nationale d’identité au format bancaire, appelée CNIe ;
2. le composant électronique intégré à cette carte ;
3. un smartphone compatible ;
4. l’application mobile ;
5. le Service de garantie de l’identité numérique, ou SGIN.
...
L’application est actuellement réservée aux personnes majeures possédant la nouvelle CNI. La page officielle indique un minimum d’iOS 16.6 ou d’Android 11, avec la lecture NFC nécessaire sur Android. France Identité donne aussi accès à [plus de 1 800 services via FranceConnect](https://france-identite.gouv.fr/).

Le décret SGIN ne crée pas seulement un affichage numérique. Il autorise un moyen d’identification électronique permettant de s’identifier et de s’authentifier auprès d’organismes publics ou privés. L’application peut générer des attestations contenant uniquement les attributs que l’usager estime nécessaires à transmettre. [Cette finalité figure dès l’article 1er du décret](https://www.legifrance.gouv.fr/loda/id/JORFTEXT000045667825).
...
<figure class="infographic infographic-readable" style="padding-bottom:1.5rem" tabindex="0" aria-label="Infographie sur les trois étages de l’identité numérique">
<svg viewBox="0 0 720 850" width="100%" role="img" aria-labelledby="identity-layers-fr-title identity-layers-fr-desc" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:auto;overflow:hidden;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;background:#0c0d10">
<title id="identity-layers-fr-title">Les trois étages de l’identité numérique française et européenne</title>
<desc id="identity-layers-fr-desc">France Identité actuelle, identité numérique certifiée et futur portefeuille européen EUDI sont trois niveaux distincts.</desc>
<rect x="1" y="1" width="718" height="848" rx="16" fill="#0c0d10" stroke="#2b3038"/>
<text x="32" y="48" fill="#f5f6f8" font-size="21" font-weight="700">TROIS ÉTAGES, TROIS PÉRIMÈTRES</text>
<text x="32" y="74" fill="#8b909b" font-size="12">Les pilotes européens ne sont pas encore des usages courants.</text>
...
<text x="108" y="139" fill="#5eead4" font-size="14" font-weight="700">FRANCE IDENTITÉ AUJOURD’HUI</text>
<text x="108" y="166" fill="#f5f6f8" font-size="12">CNIe + téléphone compatible + application.</text>
<text x="108" y="190" fill="#d6d9df" font-size="11">CNI, permis, carte grise, justificatifs, FranceConnect,</text>
<text x="108" y="210" fill="#d6d9df" font-size="11">train, contrôles routiers et certains usages aéroportuaires.</text>
<text x="108" y="238" fill="#aeb4bf" font-size="10.5">Gratuite et facultative. Les titres physiques restent nécessaires.</text>
<text x="108" y="260" fill="#aeb4bf" font-size="10.5">Identité stockée localement selon l’architecture déclarée.</text>
...
<text x="108" y="369" fill="#7aa2f7" font-size="14" font-weight="700">IDENTITÉ NUMÉRIQUE CERTIFIÉE</text>
<text x="108" y="396" fill="#f5f6f8" font-size="12">Vérification physique en mairie ou lors de la remise de la CNI.</text>
<text x="108" y="420" fill="#d6d9df" font-size="11">Niveau de garantie élevé, FranceConnect+ et procuration</text>
<text x="108" y="440" fill="#d6d9df" font-size="11">de vote entièrement dématérialisée.</text>
<text x="108" y="468" fill="#aeb4bf" font-size="10.5">Le résultat de la demande est annoncé sous 48 heures.</text>
<text x="108" y="490" fill="#aeb4bf" font-size="10.5">Ce niveau ne transforme pas encore l’application en wallet européen.</text>
...
<text x="108" y="599" fill="#f5b13d" font-size="14" font-weight="700">PORTEFEUILLE EUROPÉEN EUDI</text>
<text x="108" y="626" fill="#f5f6f8" font-size="12">Mise à disposition attendue par les États membres fin 2026.</text>
<text x="108" y="650" fill="#d6d9df" font-size="11">Identité transfrontalière, attestations, diplômes, permis,</text>
<text x="108" y="670" fill="#d6d9df" font-size="11">coordonnées bancaires, signatures et autres attributs.</text>
<text x="108" y="698" fill="#aeb4bf" font-size="10.5">Licence open source, contrôle par l’usager et divulgation sélective.</text>
<text x="108" y="720" fill="#aeb4bf" font-size="10.5">Banque, SIM, ordonnances, voyage et paiement ont été testés.</text>
<text x="108" y="742" fill="#ffcf70" font-size="10.5" font-weight="700">TESTÉ NE SIGNIFIE PAS ENCORE DÉPLOYÉ AU QUOTIDIEN.</text>

<rect x="28" y="802" width="664" height="28" rx="7" fill="#15171b" stroke="#343943"/>
<text x="360" y="821" text-anchor="middle" fill="#8b909b" font-size="10">Sources : France Titres ; règlement eIDAS 2 ; Commission européenne. Consultation : 28 août 2026.</text>
</svg>
<figcaption>Le même nom d’application recouvre une infrastructure actuelle, un niveau certifié et un portefeuille européen encore en déploiement.</figcaption>
</figure>
...
La certification ajoute une vérification physique. L’utilisateur lance la demande dans l’application, relit sa CNI en NFC, reçoit un QR code, puis présente son téléphone et sa carte en mairie ou au consulat. France Titres annonce un résultat sous 48 heures. Depuis avril 2025, la création et la certification peuvent aussi intervenir lors de la remise d’une nouvelle CNI. [Les principaux usages actuels sont FranceConnect+ et la procuration de vote entièrement en ligne](https://france-identite.gouv.fr/identite-numerique-certifiee/).

### Le portefeuille européen EUDI

Le cadre européen doit ajouter des attestations reconnues au-delà des frontières : permis, diplômes, coordonnées bancaires, qualifications ou signatures. La Commission indique que les États membres doivent proposer un portefeuille avant la fin de 2026. Le logiciel doit être fourni sous licence open source, permettre la divulgation sélective et donner à l’utilisateur un contrôle sur les données transmises. [La Commission présente ces obligations et ce calendrier sur sa page EUDI](https://digital-strategy.ec.europa.eu/en/policies/eudi-regulation).

France Titres a coordonné les expérimentations POTENTIAL et APTITUDE. Elles ont couvert l’ouverture d’un compte bancaire, l’enregistrement d’une carte SIM, le permis mobile, la signature électronique qualifiée, les ordonnances transfrontalières, les titres de transport, les documents de voyage, la carte grise, l’authentification forte et l’initiation de paiements. [Ces scénarios sont documentés comme des pilotes](https://france-identite.gouv.fr/potential-aptitude/), pas comme autant de fonctions déjà disponibles au quotidien.
...
Dans les TGV INOUI, les Intercités et les OUIGO, le QR code transmet le nom, le prénom et la date de naissance. Le contrôle fonctionne sans connexion Internet. Le billet doit toujours être acheté et les mêmes informations ont été renseignées lors de l’achat. [La page d’usage détaille ce fonctionnement](https://france-identite.gouv.fr/usages/utiliser-france-identite-dans-les-trains/).
...
La page de sécurité de France Identité affirme que les données d’identité ne sont pas conservées sur les serveurs et qu’elles sont stockées uniquement dans l’application. [La formulation est directe](https://france-identite.gouv.fr/securite-application/).
...
3. l’AIPD communicable ;
4. le décret SGIN en vigueur.
...
<figure class="infographic infographic-readable" style="padding-bottom:1.5rem" tabindex="0" aria-label="Infographie comparant quatre documents sur les données de France Identité">
<svg viewBox="0 0 720 1040" width="100%" role="img" aria-labelledby="identity-docs-fr-title identity-docs-fr-desc" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:auto;overflow:hidden;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;background:#0c0d10">
<title id="identity-docs-fr-title">Quatre documents publics décrivent différemment les données de France Identité</title>
<desc id="identity-docs-fr-desc">La communication, la politique de confidentialité, l’AIPD et le décret présentent des périmètres et durées qui doivent être réconciliés.</desc>
<rect x="1" y="1" width="718" height="1038" rx="16" fill="#0c0d10" stroke="#2b3038"/>
<text x="32" y="48" fill="#f5f6f8" font-size="21" font-weight="700">UNE IDENTITÉ, QUATRE DESCRIPTIONS</text>
<text x="32" y="74" fill="#8b909b" font-size="12">Le plafond juridique ne décrit pas forcément la base réellement exploitée.</text>

<rect x="28" y="104" width="664" height="164" rx="14" fill="#10211f" stroke="#5eead4"/>
<text x="50" y="137" fill="#5eead4" font-size="13" font-weight="700">1. COMMUNICATION PUBLIQUE</text>
<text x="50" y="164" fill="#f5f6f8" font-size="12">« Données d’identité non conservées sur des serveurs »</text>
<text x="50" y="188" fill="#d6d9df" font-size="11">Stockage annoncé uniquement dans l’application.</text>
<text x="50" y="210" fill="#aeb4bf" font-size="10.5">Promesse simple, mais elle ne décrit ni le transit ni les journaux.</text>
<text x="50" y="232" fill="#aeb4bf" font-size="10.5">Source : page « Sécurité de l’application ».</text>

<rect x="28" y="288" width="664" height="198" rx="14" fill="#141a28" stroke="#7aa2f7"/>
<text x="50" y="321" fill="#7aa2f7" font-size="13" font-weight="700">2. AIPD PUBLIQUE</text>
<text x="50" y="348" fill="#f5f6f8" font-size="12">Attributs : transit pour la transaction, puis suppression.</text>
<text x="50" y="372" fill="#d6d9df" font-size="11">Numéro du titre : identifiant permettant de corréler les opérations.</text>
<text x="50" y="394" fill="#d6d9df" font-size="11">Durée « en principe » de cinq ans, avec purge annoncée à trois ans.</text>
<text x="50" y="416" fill="#d6d9df" font-size="11">Journaux : identifiant, date, heure, type d’opération, trois ans.</text>
<text x="50" y="446" fill="#aeb4bf" font-size="10.5">Le document emploie aussi « aucune donnée personnelle stockée »,</text>
<text x="50" y="466" fill="#aeb4bf" font-size="10.5">alors qu’un numéro de titre et des logs restent des données personnelles.</text>

<rect x="28" y="506" width="664" height="210" rx="14" fill="#1b1b14" stroke="#f5b13d"/>
<text x="50" y="539" fill="#f5b13d" font-size="13" font-weight="700">3. POLITIQUE DE CONFIDENTIALITÉ</text>
<text x="50" y="566" fill="#f5f6f8" font-size="12">Le serveur « traite » titre, contact et identifiant du téléphone.</text>
<text x="50" y="590" fill="#d6d9df" font-size="11">Une phrase regroupe identifiants, identité et technique sur trois ans.</text>
<text x="50" y="612" fill="#d6d9df" font-size="11">Plus loin : attributs supprimés après transaction, numéro du titre</text>
<text x="50" y="634" fill="#d6d9df" font-size="11">et traces conservés. Politique et AIPD divergent sur la désinstallation.</text>
<text x="50" y="664" fill="#aeb4bf" font-size="10.5">La distinction entre traitement temporaire et stockage durable existe,</text>
<text x="50" y="686" fill="#aeb4bf" font-size="10.5">mais elle n’est pas présentée de manière uniforme.</text>

<rect x="28" y="736" width="664" height="198" rx="14" fill="#21151c" stroke="#ff85ad"/>
<text x="50" y="769" fill="#ff85ad" font-size="13" font-weight="700">4. DÉCRET SGIN</text>
<text x="50" y="796" fill="#f5f6f8" font-size="12">Autorise un périmètre large de données sur le serveur pendant cinq ans,</text>
<text x="50" y="820" fill="#d6d9df" font-size="11">sauf l’historique des transactions, conservé sur le téléphone.</text>
<text x="50" y="842" fill="#d6d9df" font-size="11">Les opérations de création, consultation, utilisation, révocation</text>
<text x="50" y="864" fill="#d6d9df" font-size="11">et suppression sont journalisées pendant trois ans.</text>
<text x="50" y="894" fill="#aeb4bf" font-size="10.5">La CNIL avait déjà noté que la minimisation réelle n’apparaissait</text>
<text x="50" y="916" fill="#aeb4bf" font-size="10.5">pas dans la rédaction très large de l’article 4.</text>

<rect x="28" y="958" width="664" height="56" rx="10" fill="#15171b" stroke="#4a505a"/>
<text x="360" y="981" text-anchor="middle" fill="#f5f6f8" font-size="11" font-weight="700">CONCLUSION DOCUMENTAIRE</text>
<text x="360" y="1002" text-anchor="middle" fill="#aeb4bf" font-size="10">Pas de preuve d’une base cachée. Besoin d’un dictionnaire public champ par champ.</text>
</svg>
<figcaption>Les textes peuvent être compatibles si le décret fixe un plafond large et si l’implémentation utilise un sous-ensemble. Cette articulation doit être publiée clairement.</figcaption>
</figure>
...
L’article 4 indique que, sauf l’historique des transactions, ces données sont stockées sur le serveur et conservées cinq ans à compter de la dernière vérification d’identité. Elles doivent être supprimées lorsque l’usager supprime son identité numérique, désinstalle l’application ou demeure inactif pendant deux ans. [Le texte consolidé est accessible sur Légifrance](https://www.legifrance.gouv.fr/loda/id/JORFTEXT000045667825).

L’article 5 impose par ailleurs un journal des opérations de création, consultation, utilisation, révocation et suppression. Il contient l’identifiant de l’auteur, la date, l’heure et l’objet de l’opération, avec trois ans de conservation. [L’article 5 peut être consulté séparément](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000045670675).
...
<div role="region" aria-labelledby="trace-tool-fr-title" style="margin:1.5rem 0;padding:1.1rem;border:1px solid #343943;border-radius:14px;background:#101319">
<h3 id="trace-tool-fr-title" style="margin:0 0 .45rem;color:#f5f6f8;font-size:1.12rem">Explorateur de traces</h3>
<p style="margin:.25rem 0 1rem;color:#aeb4bf">Ouvrez un usage. L’outil sépare la preuve visible, le transit documenté, la conservation déclarée et l’inconnue restante. Il ne remplace pas une analyse du trafic réseau ni les politiques propres au destinataire.</p>

<details style="margin:.65rem 0;border:1px solid #2f3842;border-radius:10px;background:#0c0d10">
<summary style="cursor:pointer;padding:.85rem 1rem;color:#5eead4;font-weight:700">Aéroport : carte verticale</summary>
<div style="padding:0 1rem 1rem;color:#d6d9df">
<p><strong>Preuve visible :</strong> nom, prénom et photographie.</p>
<p><strong>Fonction :</strong> rapprochement d’identité par la compagnie lors de l’enregistrement des bagages et de l’embarquement.</p>
<p><strong>Transit documenté :</strong> la page d’usage décrit une présentation à l’écran. Elle ne documente pas un échange serveur propre à ce contrôle.</p>
<p><strong>Inconnue restante :</strong> les éventuelles traces conservées par la compagnie aérienne ou son prestataire ne sont pas détaillées sur cette page.</p>
</div>
</details>

<details style="margin:.65rem 0;border:1px solid #2f3842;border-radius:10px;background:#0c0d10">
<summary style="cursor:pointer;padding:.85rem 1rem;color:#7aa2f7;font-weight:700">Train : QR code hors ligne</summary>
<div style="padding:0 1rem 1rem;color:#d6d9df">
<p><strong>Preuve transmise :</strong> nom, prénom et date de naissance, déjà fournis lors de l’achat du billet.</p>
<p><strong>Fonction :</strong> contrôle conjoint du billet et de l’identité dans les TGV INOUI, Intercités et OUIGO.</p>
<p><strong>Transit documenté :</strong> la lecture fonctionne sans connexion Internet, donc sans appel réseau nécessaire au moment du contrôle.</p>
<p><strong>Inconnue restante :</strong> la page officielle ne précise pas si l’appareil du contrôleur conserve un journal local du scan avant synchronisation.</p>
</div>
</details>

<details style="margin:.65rem 0;border:1px solid #2f3842;border-radius:10px;background:#0c0d10">
<summary style="cursor:pointer;padding:.85rem 1rem;color:#f5b13d;font-weight:700">Connexion en ligne : SGIN et FranceConnect</summary>
<div style="padding:0 1rem 1rem;color:#d6d9df">
<p><strong>Preuve transmise :</strong> les attributs demandés par le parcours, via SGIN, FranceConnect ou un service raccordé.</p>
<p><strong>Transit documenté :</strong> l’AIPD décrit un passage temporaire des attributs par le serveur pour réaliser la transaction.</p>
<p><strong>Conservation déclarée :</strong> les attributs sont annoncés comme supprimés après l’opération ; le numéro du titre et les traces d’usage peuvent rester.</p>
<p><strong>Inconnue restante :</strong> le contenu précis de « l’objet de l’opération » dans les journaux publics n’est pas défini champ par champ.</p>
</div>
</details>

<details style="margin:.65rem 0;border:1px solid #2f3842;border-radius:10px;background:#0c0d10">
<summary style="cursor:pointer;padding:.85rem 1rem;color:#ff85ad;font-weight:700">Justificatif à usage unique</summary>
<div style="padding:0 1rem 1rem;color:#d6d9df">
<p><strong>Preuve transmise :</strong> une attestation signée contenant les attributs sélectionnés et une durée choisie.</p>
<p><strong>Transit documenté :</strong> la génération peut mobiliser SGIN ; les attributs sont annoncés comme supprimés après la transaction.</p>
<p><strong>Conservation déclarée :</strong> l’attestation reste sous le contrôle de l’usager jusqu’à son envoi.</p>
<p><strong>Inconnue restante :</strong> une fois reçue, sa conservation dépend du destinataire, de sa base juridique et de sa propre politique de données.</p>
</div>
</details>

<p style="margin:1rem 0 0;color:#777f8b;font-size:.86rem">Sources : pages d’usage France Identité, politique de confidentialité, AIPD SGIN et décret n° 2022-676. Consultation : 28 août 2026.</p>
</div>
...
Ce risque de corrélation par des identifiants et des métadonnées apparaît aussi dans notre [enquête sur les flux de données de l’euro numérique](/posts/euro-numerique-3-prive-comme-du-cash/). Les deux infrastructures sont distinctes, mais la méthode de lecture reste la même : séparer la donnée visible, l’identifiant technique, le journal et l’acteur capable de les relier.
...
1. certains attributs peuvent transiter par les serveurs ;
2. un numéro de titre et des journaux d’opérations sont conservés ;
3. les documents publics ne décrivent pas ces données et leurs durées de manière parfaitement cohérente.
...
- [France Identité dans les aéroports français](https://france-identite.gouv.fr/actualite/embarquer_avec_france_identite.html)
- [Page d’accueil et conditions techniques](https://france-identite.gouv.fr/)
- [Identité numérique certifiée](https://france-identite.gouv.fr/identite-numerique-certifiee/)
- [Usage dans les trains](https://france-identite.gouv.fr/usages/utiliser-france-identite-dans-les-trains/)
- [Généralisation de février 2024](https://www.interieur.gouv.fr/actualites/communiques-de-presse/generalisation-de-lapplication-france-identite-et-lancement-du)
- [Bilan officiel de mars 2026](https://www.interieur.gouv.fr/actualites/communiques-de-presse/france-identite-deja-4-millions-dutilisateurs-et-acceleration-des-usages-pour-simplifier-quotidien)
- [Bilan chiffré définitif des procurations municipales de 2026](https://www.interieur.gouv.fr/actualites/communiques-de-presse/elections-municipales-et-communautaires-2026-bilan-chiffre-du-premier-et-du-second-tour)
- [Politique de confidentialité](https://france-identite.gouv.fr/politique-de-confidentialite/confidentialite-fi/)
- [Page de sécurité](https://france-identite.gouv.fr/securite-application/)
- [AIPD communicable du SGIN](https://france-identite.gouv.fr/assets/files/AIPD_SGIN_Conforme.pdf)
- [Décret SGIN consolidé](https://www.legifrance.gouv.fr/loda/id/JORFTEXT000045667825)
- [Avis de la CNIL](https://france-identite.gouv.fr/decrets-et-avis-cnil/)
- [Expérimentations POTENTIAL et APTITUDE](https://france-identite.gouv.fr/potential-aptitude/)
- [Cadre EUDI présenté par la Commission européenne](https://digital-strategy.ec.europa.eu/en/policies/eudi-regulation)
- [Règlement (UE) 2024/1183](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:32024R1183)
