---
title: "Ormuz : la chaîne d'approvisionnement encaisse, la facture est déjà là"
...
<svg viewBox="0 0 720 320" role="img" aria-label="Part des flux mondiaux qui transitent par le détroit d'Ormuz" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  ...
  <rect x="40" y="108" width="150" height="24" fill="#5eead4" opacity="0.9"></rect>
  <text x="470" y="125" fill="#5eead4" font-size="12" font-weight="700">~25 % du pétrole maritime</text>
  <text x="40" y="158" fill="#d6d9df" font-size="12">Gaz naturel liquéfié (GNL)</text>
  <rect x="40" y="168" width="600" height="24" fill="#2a2c33"></rect>
  <rect x="40" y="168" width="120" height="24" fill="#f5b13d" opacity="0.9"></rect>
  <text x="500" y="185" fill="#f5b13d" font-size="12" font-weight="700">~20 % du commerce mondial</text>
  <text x="40" y="218" fill="#d6d9df" font-size="12">Matières premières pour engrais</text>
  <rect x="40" y="228" width="600" height="24" fill="#2a2c33"></rect>
  <rect x="40" y="228" width="200" height="24" fill="#ff4d87" opacity="0.9"></rect>
  <text x="450" y="245" fill="#ff4d87" font-size="12" font-weight="700">jusqu'à ~1/3 du commerce mondial</text>
  <line x1="40" y1="276" x2="680" y2="276" stroke="#2a2c33" stroke-width="1"></line>
  <text x="40" y="298" fill="#8b909b" font-size="11">Sources : IEA, EIA, World Economic Forum. Contournement limité : 3,5 à 5,5 Mb/j de pipelines.</text>
</svg>
<figcaption>Un cinquième du pétrole mondial, un cinquième du GNL et jusqu'à un tiers des matières premières pour engrais passent par Ormuz. Les pipelines de contournement saoudiens et émiratis ne peuvent en dérouter que <strong>3,5 à 5,5 millions de barils par jour</strong>. Sources : IEA, EIA, World Economic Forum.</figcaption>
</figure>

C'est cette concentration qui rend le détroit indispensable : il n'existe pas de plan B à la hauteur. Les pipelines saoudiens et émiratis qui contournent Ormuz plafonnent, selon l'IEA, entre 3,5 et 5,5 millions de barils par jour. Rapporté à un flux de 20 millions, cela laisse un déficit potentiel de 14 à 16 millions de barils par jour qu'aucune infrastructure ne peut absorber. Le point est développé dans notre [état des lieux du chokepoint bloqué](/posts/point-situation-detroit-ormuz-avril-2026/).
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 320" role="img" aria-label="Surcoûts de transport maritime provoqués par la crise d'Ormuz" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="320" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">La facture du détour, déjà dans les prix</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">Surcoûts du transport maritime depuis la fermeture du détroit.</text>
  <text x="40" y="94" fill="#d6d9df" font-size="12">Indice de fret Shanghai (SCFI), fin février</text>
  <rect x="40" y="104" width="140" height="20" fill="#8b909b" opacity="0.85"></rect>
  <text x="192" y="120" fill="#d6d9df" font-size="11">base</text>
  <text x="40" y="146" fill="#5eead4" font-size="12" font-weight="700">SCFI, semaine au 30 mai : 2 572 pts</text>
  <rect x="40" y="156" width="280" height="20" fill="#5eead4" opacity="0.9"></rect>
  <text x="330" y="172" fill="#5eead4" font-size="11" font-weight="700">x2</text>
  <line x1="40" y1="196" x2="680" y2="196" stroke="#2a2c33" stroke-width="1"></line>
  <text x="40" y="220" fill="#d6d9df" font-size="12">Surcharge risque de guerre : jusqu'à 1 500 $ / EVP</text>
  <text x="40" y="244" fill="#d6d9df" font-size="12">Hausse de fret d'urgence (Golfe) : 3 000 $ / FEU</text>
  <text x="40" y="268" fill="#d6d9df" font-size="12">Fioul marin (VLSFO) : prix doublé</text>
  <text x="40" y="292" fill="#f5b13d" font-size="12">Contournement par le cap de Bonne-Espérance : +10 à 14 jours</text>
  <text x="360" y="314" fill="#8b909b" font-size="11">Sources : Lloyd's List, Freightos, SeaVantage.</text>
</svg>
<figcaption>Le fret conteneurisé au départ de Shanghai a doublé par rapport à fin février, et les surcharges s'empilent : jusqu'à <strong>1 500 dollars par EVP</strong> de risque de guerre, <strong>3 000 dollars par FEU</strong> de fret d'urgence pour le Golfe. Sources : Lloyd's List, Freightos.</figcaption>
</figure>
...
Aucune région n'illustre mieux la propagation que le marché européen du gaz. Le Qatar, dont les cargaisons empruntent Ormuz, a suspendu une partie de sa production sous régime de force majeure, retirant d'un coup près d'un cinquième de l'offre mondiale de GNL. Le prix de référence européen, le [TTF](/glossaire/ttf/) néerlandais, a bondi de 35 % en une seule séance pour dépasser 60 euros le mégawattheure, et de 76 % sur la semaine.
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 300" role="img" aria-label="Trajectoire du prix de référence du gaz européen TTF selon la durée de la crise" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="300" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Le gaz européen, du calme au vertige</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">Prix de référence TTF, en euros par mégawattheure, selon la durée de l'arrêt qatari.</text>
  <line x1="60" y1="240" x2="680" y2="240" stroke="#2a2c33" stroke-width="1"></line>
  <rect x="90" y="215" width="70" height="25" fill="#8b909b" opacity="0.85"></rect>
  <text x="104" y="205" fill="#d6d9df" font-size="11">~50</text>
  <text x="86" y="262" fill="#8b909b" font-size="10.5">avant-crise</text>
  <rect x="230" y="198" width="70" height="42" fill="#5eead4" opacity="0.9"></rect>
  <text x="242" y="188" fill="#5eead4" font-size="11" font-weight="700">60+</text>
  <text x="226" y="262" fill="#8b909b" font-size="10.5">pic à J+1</text>
  <rect x="370" y="123" width="70" height="117" fill="#f5b13d" opacity="0.9"></rect>
  <text x="378" y="113" fill="#f5b13d" font-size="11" font-weight="700">~155</text>
  <text x="360" y="262" fill="#8b909b" font-size="10.5">arrêt 3 mois</text>
  <rect x="510" y="90" width="70" height="150" fill="#ff4d87" opacity="0.9"></rect>
  <text x="516" y="80" fill="#ff4d87" font-size="11" font-weight="700">200+</text>
  <text x="500" y="262" fill="#8b909b" font-size="10.5">arrêt 6 mois</text>
  <text x="40" y="290" fill="#8b909b" font-size="11">Sources : Euronews, CNBC, IEEFA. Scénarios d'analystes ; le TTF a fait +76 % sur la première semaine.</text>
</svg>
<figcaption>Parti d'environ <strong>50 euros</strong> le mégawattheure, le TTF a bondi de 76 % dès la première semaine, et les scénarios d'un arrêt qatari prolongé pointent vers <strong>155 à plus de 200 euros</strong>. Sources : Euronews, CNBC, IEEFA.</figcaption>
</figure>
...
Le signal apparaît aussi en amont, dans les prix à l'import, dont la hausse mensuelle a surpris, comme nous l'avons analysé dans [les petits caractères des prix à l'import](/posts/prix-import-mai-2026-petits-caracteres/). Et il se lit dans les flux physiques : les importations chinoises de brut ont chuté à leur plus bas niveau depuis mi-2022, la Chine préférant [puiser dans ses stocks](/posts/petrole-le-stock-chinois-qui-plafonne-les-prix/) plutôt que d'acheter au prix fort. La [facture asiatique du choc](/posts/crise-ormuz-asie-impacts-economiques/) et le [risque de pénurie de cuivre](/posts/cuivre-shortage-ormuz-el-nino-2026/) prolongent la même onde. La crise n'est pas un risque futur à surveiller : c'est un coût présent qui se répartit déjà entre importateurs, industriels et ménages.

Pour les banques centrales, ce type de choc est le plus inconfortable qui soit. Un choc d'offre pousse en même temps les prix à la hausse et l'activité à la baisse, la définition même de la stagflation. Resserrer la politique monétaire pour contrer l'inflation importée aggrave le frein sur la croissance ; l'assouplir pour soutenir l'activité laisse filer les anticipations de prix. La Réserve fédérale présidée par Kevin Warsh, dont nous avons décrit le [premier FOMC](/posts/warsh-premier-fomc-juin-2026/), a hérité de ce dilemme au moment précis où elle entendait normaliser sa politique. Le détroit d'Ormuz a, en quelques semaines, retiré aux banquiers centraux le luxe d'un choix simple.
