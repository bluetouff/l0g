...
<svg viewBox="0 0 720 300" role="img" aria-label="Crédit en devises hors zone d'émission : dollar, euro, yen" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  ...
  <text x="32" y="154" fill="#ff4d87" font-size="12">EURO (hors zone)</text>
  <rect x="200" y="142" width="180" height="26" fill="#ff4d87" opacity="0.85"></rect>
  <text x="390" y="160" fill="#d6d9df" font-size="12">4 900 Md€ · +11 %</text>
  <text x="32" y="204" fill="#f5b13d" font-size="12">YEN (hors Japon)</text>
  <rect x="200" y="192" width="120" height="26" fill="#f5b13d" opacity="0.7"></rect>
  <text x="330" y="210" fill="#d6d9df" font-size="12">en recul · -4,9 %</text>
  <text x="32" y="262" fill="#d6d9df" font-size="12">Le crédit dollar hors US croît au rythme le plus rapide depuis 2014.</text>
  <text x="32" y="282" fill="#8b909b" font-size="12">Dont 4 300 Md$ vers les économies émergentes, contre 3 200 dix ans plus tôt.</text>
</svg>
<figcaption>Le crédit dollar aux non-banques hors des États-Unis domine très largement le crédit offshore en euros et en yen. Données fin 2025. Source : BIS, indicateurs de liquidité mondiale, publication du 30 avril 2026.</figcaption>
</figure>
...
<svg viewBox="0 0 720 320" role="img" aria-label="Dette dollar visible au bilan contre dette cachée dans les swaps de change" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  ...
  <text x="32" y="190" fill="#ff4d87" font-size="12">HORS BILAN, SWAPS DE CHANGE (manquante)</text>
  <rect x="32" y="200" width="320" height="34" fill="#ff4d87" opacity="0.85"></rect>
  <text x="364" y="222" fill="#d6d9df" font-size="12">~26 000 Md$</text>
  <text x="32" y="284" fill="#d6d9df" font-size="12">La dette cachée vaut environ le double de la dette visible,</text>
  <text x="32" y="304" fill="#8b909b" font-size="12">et la Fed l'a renflouée en 2008 et en 2020 sans la voir en entier.</text>
</svg>
<figcaption>Pour les seules non-banques hors des États-Unis, les obligations dollar logées dans les swaps de change valent environ le double de leur dette inscrite au bilan. Pour les banques non américaines, le hors bilan dépasse 39 000 milliards de dollars. Source : BIS, Quarterly Review, décembre 2022 (Borio, McCauley, McGuire).</figcaption>
</figure>
