---
title: 'Données personnelles : ce que les acheteurs paient vraiment'
seoTitle: 'Données personnelles : les acheteurs et leurs contrats | l0g'
ogTitle: 'Le commerce de nos traces (4/6) : ce que les acheteurs paient'
...
quickTake:
  ...
  importance: Le contenu livré, les droits accordés et l’usage réel déterminent des produits différents. Un contrat
    ou une dépense ne prouve pas à lui seul une conséquence pour une personne.
...
Les deux acheteurs étaient Verisk et LexisNexis Risk Solutions. Ce détail contractuel est plus instructif qu’une liste de partenaires : **il sépare ce qui peut être vendu, ce qui est livré et ce qui sert effectivement au produit du client.** Le besoin déclaré, évaluer un comportement au volant, ne décrit donc pas à lui seul le contenu du fichier transmis. [S01](#source-1)
