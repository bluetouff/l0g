---
title: "Coupes d'aide et choc sur les engrais : le risque alimentaire qui converge sur les pays pauvres"
description: "USAID démantelée en 2025, détroit d'Ormuz perturbé en 2026 : deux chocs se superposent sur les mêmes pays importateurs. Ce que disent réellement les chiffres du WFP, de la FAO et du Lancet, sans extrapolation."
pubDate: 2026-04-10T09:00:00+02:00
...
<svg viewBox="0 0 720 220" role="img" aria-label="Projections de surmortalité liées aux coupes d'aide" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect x="0" y="0" width="720" height="220" fill="#0c0d10"/>
  <text x="20" y="30" fill="#8b909b" font-size="12">Surmortalité projetée d'ici 2030 (millions, fourchettes)</text>
  <!-- axe -->
  <line x1="250" y1="50" x2="250" y2="180" stroke="rgba(255,255,255,0.12)"/>
  <!-- echelle 0..24 sur 250..690 -->
  <!-- CGDev 0.5-1.0 (2025) -->
  <text x="235" y="78" text-anchor="end" fill="#f5f6f8" font-size="12">CGDev (2025)</text>
  <rect x="250" y="68" width="18" height="14" fill="#5eead4"/>
  <text x="276" y="79" fill="#8b909b" font-size="11">0,5 à 1,0</text>
  <!-- Lancet USAID 8.5-19.7, central 14 -->
  ...
  <text x="617" y="119" fill="#8b909b" font-size="11">14 [8,5 à 19,7]</text>
  <!-- Lancet GH 9.4-22.6 -->
...
<figure class="infographic">
<svg viewBox="0 0 720 210" role="img" aria-label="Échelle de gravité de l'insécurité alimentaire" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect x="0" y="0" width="720" height="210" fill="#0c0d10"/>
  <text x="20" y="30" fill="#8b909b" font-size="12">Gravité de la faim aiguë, 2025 (personnes)</text>
  <!-- niveaux empilés -->
  <rect x="20" y="50" width="660" height="34" fill="#5eead4" opacity="0.20"/>
  <text x="34" y="72" fill="#f5f6f8" font-size="13">~318 M · faim aiguë (phase 3 et plus)</text>
