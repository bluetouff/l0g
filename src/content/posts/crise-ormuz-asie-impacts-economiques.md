...
La séquence est désormais documentée. La guerre déclenchée le 28 février 2026 a conduit l'Iran à fermer le détroit début mars, suivie d'un blocus américain des ports iraniens d'avril à fin mai. Le [conflit](/posts/la-guerre-diran-2026-seisme-economique-politique/) a été suspendu par un mémorandum d'entente signé le 17 juin au château de Versailles, qui implique [une réouverture du détroit](/posts/accord-paix-ormuz-rouvre-scenarios/) et la levée du blocus. Le trafic commercial est remonté les 18 et 19 juin, avant que Téhéran n'annonce une nouvelle fermeture le 20 juin, contestée par Washington. La trêve est donc réelle mais précaire, et la facture analysée ci-dessous est largement cumulée : elle ne s'efface pas avec la signature.
...
Les révisions institutionnelles convergent. La Banque asiatique de développement ([ADB](/glossaire/#adb)), dans une mise à jour spéciale du 29 avril 2026, a abaissé sa prévision de croissance pour l'Asie-Pacifique à **4,7 %** en 2026 et **4,8 %** en 2027, contre **5,1 %** dans les deux cas auparavant, et relevé l'inflation régionale 2026 de **3,6 % à 5,2 %**, sur une hypothèse de pétrole autour de **96 dollars** le baril, contre 69 dollars avant le conflit. Le [FMI](/glossaire/#fmi), dans ses perspectives d'avril 2026, a ramené la croissance **mondiale** à **3,1 %** en 2026, contre 3,4 % en 2025, et relevé l'inflation mondiale à **4,4 %**, sur l'hypothèse d'une hausse de **19 %** des prix de l'énergie ; la zone euro tombe à 1,1 %. La Banque mondiale, enfin, projette une hausse des prix de l'énergie de **24 %** en 2026, le niveau le plus élevé depuis l'invasion de l'Ukraine, et une hausse de **16 %** de l'ensemble des matières premières. Le Programme des Nations unies pour le développement ([PNUD](/glossaire/#pnud)) estime que l'escalade pourrait coûter à la région entre **97 et 299 milliards de dollars** de production perdue et précipiter **8,8 millions de personnes** supplémentaires dans la pauvreté.

<figure class="infographic">
<svg viewBox="0 0 720 360" role="img" aria-label="Révisions des prévisions 2026 pour l'Asie" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect x="0" y="0" width="720" height="360" fill="#0c0d10"/>
  <text x="32" y="30" fill="#f5f6f8" font-size="13">CROISSANCE EN BAISSE, INFLATION EN HAUSSE (ASIE-PACIFIQUE)</text>
  <text x="32" y="48" fill="#8b909b" font-size="11">prévisions ADB, mise à jour spéciale du 29 avril 2026</text>
  <line x1="408" y1="66" x2="408" y2="246" stroke="rgba(255,255,255,0.12)" stroke-width="1"/>
  <line x1="576" y1="66" x2="576" y2="246" stroke="rgba(255,255,255,0.12)" stroke-width="1"/>
  <text x="408" y="262" fill="#8b909b" font-size="10" text-anchor="middle">4 %</text>
  <text x="576" y="262" fill="#8b909b" font-size="10" text-anchor="middle">5 %</text>
  <circle cx="498" cy="44" r="5" fill="#8b909b"/><text x="508" y="48" fill="#8b909b" font-size="10">avant</text>
  <circle cx="566" cy="44" r="5" fill="#5eead4"/><text x="576" y="48" fill="#8b909b" font-size="10">après</text>
  <text x="32" y="96" fill="#f5f6f8" font-size="11.5">croissance Asie 2026</text>
  <line x1="526" y1="110" x2="593" y2="110" stroke="rgba(255,255,255,0.30)" stroke-width="1"/>
  <circle cx="593" cy="110" r="6" fill="#8b909b"/><text x="603" y="114" fill="#8b909b" font-size="11">5,1</text>
  <circle cx="526" cy="110" r="6" fill="#5eead4"/><text x="516" y="114" fill="#5eead4" font-size="11" text-anchor="end">4,7 %</text>
  <text x="32" y="146" fill="#f5f6f8" font-size="11.5">croissance Asie 2027</text>
  <line x1="542" y1="160" x2="593" y2="160" stroke="rgba(255,255,255,0.30)" stroke-width="1"/>
  <circle cx="593" cy="160" r="6" fill="#8b909b"/><text x="603" y="164" fill="#8b909b" font-size="11">5,1</text>
  <circle cx="542" cy="160" r="6" fill="#5eead4"/><text x="532" y="164" fill="#5eead4" font-size="11" text-anchor="end">4,8 %</text>
  <text x="32" y="196" fill="#f5f6f8" font-size="11.5">inflation Asie 2026</text>
  <line x1="341" y1="210" x2="610" y2="210" stroke="rgba(255,255,255,0.30)" stroke-width="1"/>
  <circle cx="341" cy="210" r="6" fill="#8b909b"/><text x="331" y="214" fill="#8b909b" font-size="11" text-anchor="end">3,6</text>
  <circle cx="610" cy="210" r="6" fill="#ff4d87"/><text x="620" y="214" fill="#ff4d87" font-size="11">5,2 %</text>
  <rect x="32" y="270" width="656" height="44" fill="none" stroke="#f5b13d"/>
  <text x="48" y="288" fill="#8b909b" font-size="11">Banque mondiale · prix de l'énergie 2026</text>
  <text x="48" y="306" fill="#f5b13d" font-size="15">+24 % · plus haut niveau depuis l'invasion de l'Ukraine</text>
  <text x="32" y="344" fill="#8b909b" font-size="10.5">Le FMI ramène par ailleurs la croissance mondiale à 3,1 % en 2026 (inflation 4,4 %).</text>
</svg>
<figcaption>Révisions des prévisions 2026 pour l'Asie. Sources : Banque asiatique de développement, mise à jour spéciale du 29 avril 2026 ; Banque mondiale, Commodity Markets Outlook (28 avril 2026) ; FMI, World Economic Outlook (avril 2026) pour le chiffre mondial. Croissance et inflation sont des taux annuels ; la variation des prix de l'énergie est une évolution sur l'année.</figcaption>
</figure>

## L'industrie asiatique sous le choc du naphta

Au-delà du brut, c'est l'appareil industriel asiatique qui a été perturbé. La rupture la plus emblématique concerne le naphta, dérivé du pétrole présent dans une gamme vertigineuse de produits, des films plastiques aux encres industrielles en passant par les dispositifs médicaux. Le Japon et la Corée du Sud dépendent massivement du naphta importé du Qatar et du Koweït, dont les exportations ont été entravées par le blocage du [détroit d'Ormuz](/posts/point-situation-detroit-ormuz-avril-2026/).
...
La flambée des prix de l'énergie a placé les banques centrales asiatiques face à un dilemme redoutable. Le [Brent](/glossaire/#brent) a dépassé les **100 dollars** le baril au plus fort de la crise, en hausse de quelque 65 % sur le seul mois de mars selon la Banque mondiale, avant de refluer ; l'institution table sur une moyenne de **86 dollars** en 2026, contre 69 dollars en 2025. Près de **80 %** du brut et du [GNL](/glossaire/#gnl) bloqués étaient destinés à l'Asie, rendant la région exceptionnellement vulnérable.
