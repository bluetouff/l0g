---
title: "Liban : le grand perdant oublié, et le pari syrien très dangereux de Trump"
description: "Israël occupe près d'un cinquième du Liban, le gaz promis reste un mirage, et Donald Trump suggère désormais que la Syrie d'al-Sharaa s'occupe du Hezbollah. Analyse documentée d'un pays qui n'a rien demandé et que personne ne veut reconstruire, alors que l'Iran se voit promettre 300 milliards."
pubDate: 2026-06-18T14:00:00+02:00
tags: ["liban", "israël", "hezbollah", "syrie", "géopolitique", "trump", "gaz"]
draft: false
---
...
Israël occupe aujourd'hui près de 2 000 kilomètres carrés du sud du Liban, soit près d'un cinquième du pays, sa plus profonde incursion depuis vingt-cinq ans. Plus d'un million de Libanais ont fui, et les frappes israéliennes ont fait près de 3 800 morts depuis le 2 mars, selon le ministère libanais de la Santé. Et alors que le mémorandum signé le 17 juin entre Washington et Téhéran promet à l'Iran un plan de reconstruction d'au moins 300 milliards de dollars, personne, à ce stade, ne propose rien d'équivalent à Beyrouth. C'est la suite directe de [la guerre d'Iran de 2026](/posts/la-guerre-diran-2026-seisme-economique-politique/) et du [MOU américano-iranien](/posts/mou-usa-iran-juin-2026/), à suivre dans le [fil géopolitique du journal](/sujet/geopolitique-energie/).
...
<figure>
<svg viewBox="0 0 720 250" width="100%" role="img" aria-label="L'occupation israélienne du sud du Liban en chiffres" xmlns="http://www.w3.org/2000/svg" font-family="'JetBrains Mono Variable', ui-monospace, monospace">
<text x="20" y="26" fill="#5eead4" font-size="17">L'occupation du Sud, en chiffres</text>
<g>
<text x="40" y="92" fill="#5eead4" font-size="30" font-weight="700">≈ 2 000 km²</text>
<text x="40" y="116" fill="#8b909b" font-size="13">occupés, près d'un cinquième du Liban</text>
<text x="400" y="92" fill="#5eead4" font-size="30" font-weight="700">1 million +</text>
<text x="400" y="116" fill="#8b909b" font-size="13">personnes déplacées</text>
<text x="40" y="176" fill="#5eead4" font-size="30" font-weight="700">55</text>
<text x="40" y="200" fill="#8b909b" font-size="13">villages dans la zone contrôlée</text>
...
<figure>
<svg viewBox="0 0 720 230" width="100%" role="img" aria-label="Reconstruction promise à l'Iran contre besoins du Liban" xmlns="http://www.w3.org/2000/svg" font-family="'JetBrains Mono Variable', ui-monospace, monospace">
<text x="20" y="26" fill="#5eead4" font-size="17">Deux poids, deux mesures (en milliards de dollars)</text>
<g font-size="14">
<text x="20" y="80" fill="#e7e9ee">Iran</text>
<text x="20" y="98" fill="#8b909b" font-size="12">reconstruction promise</text>
<rect x="150" y="62" width="540" height="26" fill="#ff4d87"/>
<text x="158" y="80" fill="#0c0d10" font-size="14" font-weight="700">≥ 300</text>
<text x="20" y="150" fill="#e7e9ee">Liban</text>
<text x="20" y="168" fill="#8b909b" font-size="12">besoins (guerre 2023-2024)</text>
<rect x="150" y="132" width="20" height="26" fill="#5eead4"/>
<text x="178" y="150" fill="#e7e9ee" font-size="14">11, dont ~0,25 financé</text>
</g>
<text x="20" y="208" fill="#8b909b" font-size="12">Le besoin libanais s'alourdit encore de la guerre de 2026. Sources : MOU (NYT, Al Jazeera) pour</text>
<text x="20" y="226" fill="#8b909b" font-size="12">l'Iran ; Banque mondiale (RDNA, 2025) et programme LEAP pour le Liban.</text>
</svg>
</figure>
