...
<svg viewBox="0 0 700 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Trajectoire du Brent de février à juin 2026" style="width:100%;height:auto;background:#0c0d10;border:1px solid rgba(255,255,255,0.10);border-radius:12px">
  <text x="24" y="34" fill="#5eead4" font-family="monospace" font-size="15">// Brent 2026 : la prime de guerre, puis les séquelles (USD/baril)</text>
...
<svg viewBox="0 0 700 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Trois scénarios de remontée du trafic et de prix" style="width:100%;height:auto;background:#0c0d10;border:1px solid rgba(255,255,255,0.10);border-radius:12px">
  <text x="24" y="34" fill="#5eead4" font-family="monospace" font-size="15">// Remontée du trafic Ormuz (% des niveaux d'avant-guerre)</text>
  <g stroke="rgba(255,255,255,0.10)" stroke-width="1">
  ...
  <g fill="#b8fff5" font-family="monospace" font-size="10" text-anchor="middle">
    <text x="80" y="300">J+0</text><text x="230" y="300">J+30</text><text x="400" y="300">J+90</text><text x="580" y="300">J+180</text>
  </g>
  ...
  <text x="585" y="124" fill="#f5b13d" font-family="monospace" font-size="10">lent</text>
  <polyline fill="none" stroke="#ff4d87" stroke-width="2.5" stroke-dasharray="2 3" points="80,280 230,150 400,90 580,72"/>
  <text x="585" y="66" fill="#ff4d87" font-family="monospace" font-size="10">rapide</text>
