...
tags: ["sucre", "matières premières", "Inde", "éthanol", "énergie", "agriculture", "climat"]
draft: false
---
...
<svg viewBox="0 0 720 430" role="img" aria-label="Chronologie du retournement de la politique indienne du sucre entre février et août 2026" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="430" fill="#0c0d10"/>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Du surplus aux importations envisagées en six mois</text>
  <text x="32" y="60" fill="#8b909b" font-size="11">La politique change à mesure que la marge de sécurité disparaît.</text>

  <line x1="70" y1="112" x2="650" y2="112" stroke="#2a2c33" stroke-width="3"/>

  <circle cx="95" cy="112" r="8" fill="#5eead4"/>
  <text x="70" y="142" fill="#5eead4" font-size="11" font-weight="700">13 FÉV.</text>
  <text x="70" y="162" fill="#d6d9df" font-size="10">+500 000 t</text>
  <text x="70" y="178" fill="#d6d9df" font-size="10">d'exports recherchées</text>
  <text x="70" y="194" fill="#8b909b" font-size="9">Motif : gérer le surplus</text>

  <circle cx="270" cy="112" r="8" fill="#ff4d87"/>
  <text x="238" y="142" fill="#ff4d87" font-size="11" font-weight="700">13 MAI</text>
  <text x="238" y="162" fill="#d6d9df" font-size="10">Exportations</text>
  <text x="238" y="178" fill="#d6d9df" font-size="10">interdites</text>
  <text x="238" y="194" fill="#8b909b" font-size="9">jusqu'au 30 septembre</text>

  <circle cx="430" cy="112" r="8" fill="#f5b13d"/>
  <text x="394" y="142" fill="#f5b13d" font-size="11" font-weight="700">28 JUIL.</text>
  <text x="394" y="162" fill="#d6d9df" font-size="10">Plafond de stocks</text>
  <text x="394" y="178" fill="#d6d9df" font-size="10">pour les négociants</text>
  <text x="394" y="194" fill="#8b909b" font-size="9">jusqu'au 30 novembre</text>

  <circle cx="605" cy="112" r="8" fill="#7aa2f7"/>
  <text x="562" y="142" fill="#7aa2f7" font-size="11" font-weight="700">10-18 AOÛT</text>
  <text x="562" y="162" fill="#d6d9df" font-size="10">Moins de canne</text>
  <text x="562" y="178" fill="#d6d9df" font-size="10">vers l'éthanol ?</text>
  <text x="562" y="194" fill="#d6d9df" font-size="10">Importations ?</text>

  <rect x="40" y="246" width="640" height="116" rx="5" fill="#15171c"/>
  <text x="56" y="272" fill="#f5f6f8" font-size="12" font-weight="700">Ce que cette chronologie établit</text>
  <text x="56" y="296" fill="#d6d9df" font-size="10">La perception du bilan sucre s'est fortement détériorée pendant la campagne.</text>
  <text x="56" y="316" fill="#d6d9df" font-size="10">Elle ne démontre pas que l'éthanol est la cause unique de la tension.</text>
  <text x="56" y="336" fill="#d6d9df" font-size="10">Les deux mesures d'août sont encore des options rapportées, pas des décisions.</text>

  <text x="32" y="404" fill="#8b909b" font-size="9">SOURCES : PIB/DFPD, DGFT Notification 16/2026-27, Reuters 10 et 18 août 2026.</text>
</svg>
<figcaption>Le retournement est spectaculaire : en février, le gouvernement cherchait encore à exporter davantage. En août, il étudie des moyens de remettre du sucre sur le marché intérieur.</figcaption>
</figure>
...
Le [Department of Food and Public Distribution](https://dfpd.gov.in/directorate-of-sugar/en) donne les quantités officielles de sucre équivalent détournées vers l'éthanol :
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 455" role="img" aria-label="Quantité de sucre équivalent détournée vers l'éthanol en Inde et diversification des matières premières de l'éthanol" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="455" fill="#0c0d10"/>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Le sucre dans le réservoir : une variable, pas une constante</text>
  <text x="32" y="60" fill="#8b909b" font-size="11">Sucre équivalent détourné vers l'éthanol, millions de tonnes.</text>

  <line x1="48" y1="270" x2="420" y2="270" stroke="#2a2c33"/>
  <rect x="72" y="120" width="58" height="150" fill="#ff4d87"/>
  <text x="101" y="108" text-anchor="middle" fill="#ff4d87" font-size="13" font-weight="700">4,3</text>
  <text x="101" y="292" text-anchor="middle" fill="#d6d9df" font-size="10">2022-23</text>

  <rect x="164" y="186" width="58" height="84" fill="#f5b13d"/>
  <text x="193" y="174" text-anchor="middle" fill="#f5b13d" font-size="13" font-weight="700">2,4</text>
  <text x="193" y="292" text-anchor="middle" fill="#d6d9df" font-size="10">2023-24</text>

  <rect x="256" y="151" width="58" height="119" fill="#7aa2f7"/>
  <text x="285" y="139" text-anchor="middle" fill="#7aa2f7" font-size="13" font-weight="700">3,4</text>
  <text x="285" y="292" text-anchor="middle" fill="#d6d9df" font-size="10">2024-25</text>

  <rect x="348" y="165" width="58" height="105" fill="none" stroke="#5eead4" stroke-width="2" stroke-dasharray="5 4"/>
  <text x="377" y="140" text-anchor="middle" fill="#5eead4" font-size="11" font-weight="700">2,4 à 3,0</text>
  <text x="377" y="154" text-anchor="middle" fill="#8b909b" font-size="8">estimation</text>
  <text x="377" y="292" text-anchor="middle" fill="#d6d9df" font-size="10">2025-26</text>

  <line x1="450" y1="92" x2="450" y2="314" stroke="#2a2c33"/>
  <text x="478" y="106" fill="#d6d9df" font-size="11" font-weight="700">E20 ne dépend plus seulement</text>
  <text x="478" y="120" fill="#d6d9df" font-size="11" font-weight="700">de la canne</text>
  <text x="478" y="142" fill="#5eead4" font-size="23" font-weight="700">20 %</text>
  <text x="478" y="160" fill="#8b909b" font-size="9">mélange atteint en 2025-26</text>
  <text x="478" y="196" fill="#f5b13d" font-size="20" font-weight="700">35,96 %</text>
  <text x="478" y="214" fill="#8b909b" font-size="9">part du maïs dans l'éthanol 2025-26</text>
  <text x="478" y="248" fill="#7aa2f7" font-size="20" font-weight="700">24,64 %</text>
  <text x="478" y="266" fill="#8b909b" font-size="9">part du riz FCI dans l'éthanol 2025-26</text>
  <text x="478" y="300" fill="#d6d9df" font-size="9">Le reste inclut canne et autres</text>
  <text x="478" y="314" fill="#d6d9df" font-size="9">matières premières autorisées.</text>

  <rect x="38" y="338" width="642" height="72" rx="4" fill="#15171c"/>
  <text x="54" y="360" fill="#f5f6f8" font-size="11" font-weight="700">Conséquence</text>
  <text x="54" y="382" fill="#d6d9df" font-size="10">Réduire l'éthanol de canne ne signifie pas forcément abandonner E20.</text>
  <text x="54" y="400" fill="#d6d9df" font-size="10">Le gouvernement peut déplacer une partie de l'effort vers le maïs et le riz.</text>

  <text x="32" y="440" fill="#8b909b" font-size="9">SOURCES : DFPD, PIB 31 juillet 2026, Reuters, NFCSF. 2025-26 reste une estimation.</text>
</svg>
<figcaption>Le programme E20 s'est diversifié. La canne reste une source importante, mais la montée du maïs et du riz donne à New Delhi une possibilité de préserver le mélange à 20 % tout en restituant davantage de saccharose au marché alimentaire.</figcaption>
</figure>
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 400" role="img" aria-label="Effondrement des exportations indiennes de sucre depuis la campagne 2021-22" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="400" fill="#0c0d10"/>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Le fournisseur mondial a presque disparu</text>
  <text x="32" y="60" fill="#8b909b" font-size="11">Exportations indiennes de sucre, millions de tonnes.</text>

  <line x1="64" y1="296" x2="640" y2="296" stroke="#2a2c33"/>
  <rect x="88" y="92" width="84" height="204" fill="#5eead4"/>
  <text x="130" y="80" text-anchor="middle" fill="#5eead4" font-size="14" font-weight="700">11,0</text>
  <text x="130" y="318" text-anchor="middle" fill="#d6d9df" font-size="10">2021-22</text>

  <rect x="222" y="179" width="84" height="117" fill="#7aa2f7"/>
  <text x="264" y="167" text-anchor="middle" fill="#7aa2f7" font-size="14" font-weight="700">6,3</text>
  <text x="264" y="318" text-anchor="middle" fill="#d6d9df" font-size="10">2022-23</text>

  <rect x="356" y="294" width="84" height="2" fill="#f5b13d"/>
  <text x="398" y="274" text-anchor="middle" fill="#f5b13d" font-size="14" font-weight="700">0,1</text>
  <text x="398" y="318" text-anchor="middle" fill="#d6d9df" font-size="10">2023-24</text>

  <rect x="490" y="279" width="84" height="17" fill="#ff4d87"/>
  <text x="532" y="267" text-anchor="middle" fill="#ff4d87" font-size="14" font-weight="700">0,9</text>
  <text x="532" y="318" text-anchor="middle" fill="#d6d9df" font-size="10">2024-25</text>

  <rect x="64" y="342" width="576" height="34" rx="4" fill="#15171c"/>
  <text x="80" y="363" fill="#d6d9df" font-size="10">2025-26 : quota partiel puis interdiction d'exporter à partir du 13 mai.</text>

  <text x="32" y="392" fill="#8b909b" font-size="9">SOURCE : Department of Food and Public Distribution, Government of India.</text>
</svg>
<figcaption>L'Inde était un fournisseur capable de modifier rapidement le bilan mondial. Sa disparition des exportations oblige davantage le marché à dépendre du Brésil et de la Thaïlande.</figcaption>
</figure>
...
- [Department of Food and Public Distribution, Directorate of Sugar, politique sucrière et historique de diversion vers l'éthanol](https://dfpd.gov.in/directorate-of-sugar/en)
- [PIB, Ethanol Blending in India, 5 juillet 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2281287&lang=1&reg=3)
- [PIB, India's ethanol blended petrol programme balances food security, farmer welfare and energy security, 31 juillet 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2292225&lang=1&reg=48)
- [PIB, limites de stocks de sucre, 28 juillet 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2290498&lang=1&reg=3)
- [PIB, rainfall deficit, 22 juillet 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2287606&lang=1&reg=17)
- [PIB, impact d'El Niño sur l'agriculture du Maharashtra, 21 juillet 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2287315&lang=1&reg=1)
- [Parlement indien, Lok Sabha Question 3890, 11 août 2026](https://sansad.in/getFile/lsapps/loksabhaquestions/annex/188/AU3890_pJwfqs.pdf)
- [NOAA Climate Prediction Center, ENSO Diagnostic Discussion, 9 juillet 2026](https://www.cpc.ncep.noaa.gov/products/analysis_monitoring/enso_advisory/ensodisc.html)
- [Conab, premier relevé de la récolte brésilienne de canne 2026-27, 28 avril 2026](https://cast.conab.gov.br/post/2026-04-28_1_lev_cana_1/)
...
- [Reuters, 10 août 2026, l'Inde envisage de réduire la canne utilisée pour l'éthanol](https://www.reuters.com/world/india/india-considers-curbing-use-cane-ethanol-tame-record-high-sugar-market-2026-08-10/)
- [Reuters, 18 août 2026, l'Inde envisage des importations limitées de sucre](https://www.reuters.com/world/india/india-considers-limited-duty-free-sugar-imports-ease-record-prices-sources-say-2026-08-18/)
- [Reuters, 18 août 2026, exposition des matières premières tropicales à El Niño](https://www.reuters.com/business/environment/why-super-el-nio-leaves-tropical-commodities-acutely-exposed-2026-08-18/)
- [Reuters, 22 juin 2026, resserrement du bilan sucrier indien](https://www.reuters.com/world/china/india-likely-wont-export-sugar-years-el-nino-ethanol-squeeze-supply-2026-06-22/)
- [Reuters, 18 décembre 2025, surplus attendu et diversion vers l'éthanol](https://www.reuters.com/world/india/india-tackle-sugar-surplus-with-higher-exports-ethanol-diversion-2025-12-18/)
