...
Reste la règle d'or : lire la volatilité avec le reste du tableau de bord. Une volatilité basse conjuguée à des spreads serrés et à un [basis](/glossaire/cross-currency-basis/) tendu n'est pas un feu vert, mais un avertissement sur la faible rémunération du risque. Pour les sigles employés ici, le [glossaire](/glossaire/) reprend les définitions, et le [calendrier économique](/calendrier-eco/) recense les rendez-vous susceptibles de réveiller ces indices.
