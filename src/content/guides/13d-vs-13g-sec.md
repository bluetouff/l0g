...
Ces déclarations gagnent à être croisées avec d'autres signaux. Le [formulaire 13F](/guides/analyser-13f-sec/) montre, chaque trimestre et avec retard, l'ensemble des positions longues d'un gérant ; le [formulaire 4](/guides/analyser-form-4-sec/) montre, sous deux jours, les transactions des initiés de l'entreprise. Le 13D ajoute la dimension d'intention : un activiste qui dépose un 13D, des initiés qui achètent, des gérants respectés présents au 13F, voilà une convergence autrement plus solide qu'un signal isolé. C'est la logique de recoupement que nous exploitons dans <a href="https://13flow.eu" rel="noopener">13FLOW</a>.
