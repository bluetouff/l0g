...
Cette lecture éclaire la prudence de la Fed. Un marché gelé peut basculer vite, car le faible niveau de licenciements est un plancher fragile : si les entreprises passent du gel des embauches aux coupes d'effectifs, le chômage grimpe d'un coup. C'est ce que surveille la banque centrale à travers ses [projections du dot plot](/guides/lire-le-dot-plot-sep/), et ce que recoupe la question de fond du moment, l'effet réel de l'automatisation sur l'emploi, traitée dans notre article sur l'[IA et la productivité](/posts/ia-et-productivite-entre-gains-mesures-et-effets-supposes/). Le JOLTS ne tranche pas ce débat, mais il en donne le premier thermomètre.
