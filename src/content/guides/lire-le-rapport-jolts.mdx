...
Ce rapport se croise avec l'inflation salariale, dont le guide sur le [CPI](/guides/lire-le-cpi-inflation-us/) montre l'effet sur le pouvoir d'achat, et avec le [rapport emploi](/guides/lire-le-rapport-emploi-nfp/), dont il est l'indispensable contrepoint. Pour les sigles employés ici, le [glossaire](/glossaire/) reprend les définitions, et le [calendrier économique](/calendrier-eco/) recense les dates de publication à surveiller.
