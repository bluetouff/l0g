...
<svg viewBox="0 0 720 360" role="img" aria-label="Inversion de hiérarchie entre le spread OAT-Bund français et le spread BTP-Bund italien, de 2022 à 2026" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  ...
  <text x="70" y="336" fill="#8b909b" font-size="11">Sources : MEF italien, Borsa Italiana, Ideal Investisseur (données Banque de France, Bundesbank). Tracé schématique.</text>
</svg>
