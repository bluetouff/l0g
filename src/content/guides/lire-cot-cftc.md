...
Le COT s'inscrit dans la même famille d'outils que les autres déclarations réglementaires décryptées sur ce journal, comme les [formulaires 13F](/guides/analyser-13f-sec/). Il complète utilement la lecture des marchés à terme évoquée dans nos analyses du [basis trade sur les Treasuries](/posts/basis-trade-treasuries-levier/) et du positionnement sur l'[or](/posts/or-banques-centrales-dedollarisation-tonnes/).
