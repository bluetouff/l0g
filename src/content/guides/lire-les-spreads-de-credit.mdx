...
Pour les sigles employés ici, le [glossaire](/glossaire/) reprend les définitions. Les échéances de crédit doivent être vérifiées auprès des émetteurs et régulateurs répertoriés dans nos [sites de référence](/sites-reference/). Ce guide se lit en complément de celui sur le [marché des Treasuries](/guides/lire-le-marche-des-treasuries/), dont le spread de crédit est le miroir côté privé.
