...
sourceGuide: "lire-la-solidite-d-un-assureur-vie"
sourceUpdatedDate: 2026-07-16T18:00:00+02:00
tags: ["insurance", "private credit", "regulation", "risk", "markets"]
category: marches
draft: false
---
...
<svg viewBox="0 0 720 340" role="img" aria-label="NAIC regulatory action levels by an insurer's RBC ratio" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="340" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">An insurer's capital alert ladder</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">NAIC actions by RBC ratio (total adjusted capital / authorized control level).</text>
  ...
  <text x="200" y="104" fill="#d6d9df" font-size="12">no action, comfort zone</text>
  ...
  <text x="200" y="140" fill="#d6d9df" font-size="12">monitoring (if the trend test fails)</text>
  ...
  <text x="200" y="176" fill="#d6d9df" font-size="12">recovery plan required</text>
  ...
  <text x="200" y="212" fill="#d6d9df" font-size="12">corrective plan imposed</text>
  ...
  <text x="200" y="248" fill="#f5f6f8" font-size="12">control possible</text>
  ...
  <text x="200" y="284" fill="#0c0d10" font-size="12">mandatory control, liquidation</text>
  <text x="32" y="318" fill="#8b909b" font-size="11">A 600% ratio is not necessarily sounder than a 400% ratio. Source: NAIC.</text>
</svg>
<figcaption>The RBC ratio is an alert tool, not a ranking. Above the thresholds, comparing two high ratios is meaningless; it is below them that the figure speaks. Source: NAIC.</figcaption>
</figure>
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 300" role="img" aria-label="US life-insurance reserves ceded to reinsurance in 2024 and offshore share" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="300" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Reinsurance, and where it goes</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">US life-insurance reserves ceded in 2024, in billions of dollars.</text>
  <text x="40" y="104" fill="#d6d9df" font-size="12">Total ceded to reinsurance</text>
  ...
  <text x="40" y="178" fill="#d6d9df" font-size="12">of which offshore (Bermuda first)</text>
  ...
  <text x="40" y="252" fill="#f5b13d" font-size="12">The risk is not transferred if it goes to a same-group reinsurer.</text>
  <text x="32" y="284" fill="#8b909b" font-size="11">Source: Bloomberg (2025 investigation into US life insurance).</text>
</svg>
<figcaption>Nearly half of ceded reserves go offshore. When the reinsurer is affiliated, the cession moves the risk without taking it out of the group's perimeter. Source: Bloomberg.</figcaption>
</figure>
