...
Within these windows, several instruments meet distinct needs, per the [CRS](https://www.congress.gov/crs_external_products/R/PDF/R42019/R42019.13.pdf) definitions:
...
<svg viewBox="0 0 720 300" role="img" aria-label="The IMF's two windows and their instruments" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  ...
  <text x="56" y="164" fill="#d6d9df" font-size="12">• SBA: short term, 1 to 2 years</text>
  ...
  <text x="400" y="164" fill="#d6d9df" font-size="12">• ECF: extended program</text>
  <text x="400" y="188" fill="#d6d9df" font-size="12">• SCF: short-term need</text>
  <text x="400" y="212" fill="#d6d9df" font-size="12">• RCF: emergency, no conditionality</text>
  <text x="400" y="236" fill="#8b909b" font-size="11">Concentration is measured on the GRA.</text>
</svg>
<figcaption>The Fund's credit comes from the general window, at market rates, or the concessional window reserved for low-income countries. The weight of large borrowers reads on the GRA alone. Sources: IMF; Congressional Research Service, R42019 and IF10676.</figcaption>
</figure>
...
This threshold is not theoretical. In the Argentine case, [credit reached 1,335% of quota](/en/analysis/argentina-the-imf-largest-ever-exposure/), more than double the normal limit: the program falls entirely under exceptional access, which is why a special assessment of the Fund's exposure was published. Spotting whether a file is in normal or exceptional access is a reliable shortcut for gauging its intensity.

<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 260" role="img" aria-label="The IMF access ladder as a percent of quota" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
...
<figcaption>Below 600% of quota, access is normal; beyond it, access becomes exceptional and imposes reinforced checks. Argentina's outstanding credit, at 1,335%, sits far beyond the threshold. Sources: IMF; exposure assessment (April 2025).</figcaption>
</figure>
...
Three primary sources are enough to reconstruct a file. The [member financial position](https://www.imf.org/external/np/fin/tad/exfin2.aspx?memberKey1=30&date1key=2026-06-30) gives quota, credit outstanding and the schedule. The [GRA credit outstanding](https://www.imf.org/external/np/fin/tad/balmov2.aspx?type=GRA) table lets you compute a country's weight in the non-concessional portfolio. The [SDR valuation](https://www.imf.org/external/np/fin/data/rms_sdrv.aspx) provides the day's conversion rate. With these three pages, you rebuild a program's figures yourself, without relying on a press summary. This is the approach we followed to quantify the Argentine case and, more broadly, to place the global safety net in our analysis of [the emerging markets double squeeze](/en/analysis/emerging-markets-double-squeeze-dollar-oil/).
...
**Primary and official sources:** [IMF, member financial position (Argentina example, 30 June 2026)](https://www.imf.org/external/np/fin/tad/exfin2.aspx?memberKey1=30&date1key=2026-06-30); [IMF, GRA credit outstanding](https://www.imf.org/external/np/fin/tad/balmov2.aspx?type=GRA); [IMF, SDR valuation](https://www.imf.org/external/np/fin/data/rms_sdrv.aspx); [Congressional Research Service, "The International Monetary Fund" (IF10676)](https://www.congress.gov/crs-product/IF10676) and [detailed report R42019](https://www.congress.gov/crs_external_products/R/PDF/R42019/R42019.13.pdf) for functions, quota, US voting share and instrument definitions; [IMF, assessment of the Fund's financial exposure (April 2025)](https://www.elibrary.imf.org/view/journals/002/2025/095/article-A002-en.xml) for the normal access limit, exceptional access, precautionary balances and surcharges.

**To apply:** our X-ray of [the IMF's record exposure to Argentina](/en/analysis/argentina-the-imf-largest-ever-exposure/) and our analysis of [the emerging markets double squeeze against a strong dollar](/en/analysis/emerging-markets-double-squeeze-dollar-oil/). Counterpoint on market-based sovereign debt: [reading European sovereign debt](/en/guides/read-european-sovereign-debt/). Instrument definitions are structural; the numerical thresholds (access limit, surcharges) are reviewed periodically by the Fund, and the levels cited are those in force in mid-2026.
