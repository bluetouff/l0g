...
<svg viewBox="0 0 720 360" role="img" aria-label="Reversal of hierarchy between the French OAT-Bund spread and the Italian BTP-Bund spread, 2022 to 2026" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  ...
  <text x="32" y="59" fill="#8b909b" font-size="12" textLength="682" lengthAdjust="spacingAndGlyphs">Spread against the German Bund, in basis points. The former laggard slips below the former star pupil.</text>
  ...
  <text x="70" y="336" fill="#8b909b" font-size="11" textLength="644" lengthAdjust="spacingAndGlyphs">Sources: Italian MEF, Borsa Italiana, Ideal Investisseur (Banque de France, Bundesbank data). Schematic path.</text>
</svg>
