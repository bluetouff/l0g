...
draft: false
sourceArticle: "eurodollars-dollar-offshore-dette-cachee"
sourceUpdatedDate: 2026-06-24
---
*The most important dollar for global financial stability is not the one that circulates in the United States, but the one that lives outside it. Japanese banks, European insurers, emerging-market companies, pension funds: all borrow, lend and fund themselves in dollars without ever touching American soil. This system, the eurodollar, weighs tens of trillions, and a large part escapes both balance sheets and statistics. When it seizes up, the Federal Reserve must play firefighter to a blaze it can barely see. After [repo](/en/analysis/repo-the-liquidity-factory/) and [shadow banking](/en/analysis/shadow-banking-nonbank-intermediation/), here is the offshore floor of the dollar's plumbing.*
...
<svg viewBox="0 0 720 300" role="img" aria-label="Cross-currency credit outside the issuing zone: dollar, euro, yen" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="300" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Cross-currency credit, outside the issuing zone</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">Outstanding to non-bank borrowers, end 2025. Source: BIS, global liquidity indicators.</text>
  <text x="32" y="104" fill="#5eead4" font-size="12">DOLLAR (ex-US)</text>
  <rect x="200" y="92" width="470" height="26" fill="#5eead4" opacity="0.85"></rect>
  <text x="210" y="110" fill="#0c0d10" font-size="12" font-weight="700">$14.3trn · +8.5%</text>
  <text x="32" y="154" fill="#ff4d87" font-size="12">EURO (ex-zone)</text>
  <rect x="200" y="142" width="180" height="26" fill="#ff4d87" opacity="0.85"></rect>
  <text x="390" y="160" fill="#d6d9df" font-size="12">€4.9trn · +11%</text>
  <text x="32" y="204" fill="#f5b13d" font-size="12">YEN (ex-Japan)</text>
  <rect x="200" y="192" width="120" height="26" fill="#f5b13d" opacity="0.7"></rect>
  <text x="330" y="210" fill="#d6d9df" font-size="12">falling · -4.9%</text>
  <text x="32" y="262" fill="#d6d9df" font-size="12">Dollar credit ex-US is growing at its fastest pace since 2014.</text>
  <text x="32" y="282" fill="#8b909b" font-size="12">Of which $4.3trn to emerging economies, against $3.2trn a decade earlier.</text>
</svg>
<figcaption>Dollar credit to non-banks outside the United States dominates offshore credit in euros and yen by a wide margin. End-2025 data. Source: BIS, global liquidity indicators, 30 April 2026 release.</figcaption>
</figure>
...
<figure class="infographic">
<svg viewBox="0 0 720 320" role="img" aria-label="Visible on-balance-sheet dollar debt versus debt hidden in FX swaps" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="320" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Dollar debt visible, and hidden</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">Non-banks ex-US. BIS estimate on 2022 data. Amounts in trillions of dollars.</text>
  <text x="32" y="110" fill="#5eead4" font-size="12">ON BALANCE SHEET (visible in statistics)</text>
  <rect x="32" y="120" width="160" height="34" fill="#5eead4" opacity="0.85"></rect>
  <text x="204" y="142" fill="#d6d9df" font-size="12">~$13trn</text>
  <text x="32" y="190" fill="#ff4d87" font-size="12">OFF BALANCE SHEET, FX SWAPS (missing)</text>
  <rect x="32" y="200" width="320" height="34" fill="#ff4d87" opacity="0.85"></rect>
  <text x="364" y="222" fill="#d6d9df" font-size="12">~$26trn</text>
  <text x="32" y="284" fill="#d6d9df" font-size="12">The hidden debt is worth about double the visible debt,</text>
  <text x="32" y="304" fill="#8b909b" font-size="12">and the Fed bailed it out in 2008 and 2020 without seeing it in full.</text>
</svg>
<figcaption>For non-banks outside the United States alone, the dollar obligations lodged in FX swaps are worth about double their on-balance-sheet debt. For non-American banks, the off-balance-sheet amount exceeds $39 trillion. Source: BIS, Quarterly Review, December 2022 (Borio, McCauley, McGuire).</figcaption>
</figure>
