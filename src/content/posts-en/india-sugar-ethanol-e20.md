...
tags: ["sugar", "commodities", "India", "ethanol", "energy", "agriculture", "climate"]
draft: false
sourceArticle: "inde-sucre-ethanol-e20"
sourceUpdatedDate: 2026-08-19
---
...
<svg viewBox="0 0 720 430" role="img" aria-label="Timeline of the reversal in India's sugar policy between February and August 2026" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="430" fill="#0c0d10"/>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">From surplus to possible imports in six months</text>
  <text x="32" y="60" fill="#8b909b" font-size="11">Policy changes as the safety margin disappears.</text>

  <line x1="70" y1="112" x2="650" y2="112" stroke="#2a2c33" stroke-width="3"/>

  <circle cx="95" cy="112" r="8" fill="#5eead4"/>
  <text x="70" y="142" fill="#5eead4" font-size="11" font-weight="700">13 FEB</text>
  <text x="70" y="162" fill="#d6d9df" font-size="10">+500,000 t</text>
  <text x="70" y="178" fill="#d6d9df" font-size="10">exports sought</text>
  <text x="70" y="194" fill="#8b909b" font-size="9">Purpose: manage surplus</text>

  <circle cx="270" cy="112" r="8" fill="#ff4d87"/>
  <text x="238" y="142" fill="#ff4d87" font-size="11" font-weight="700">13 MAY</text>
  <text x="238" y="162" fill="#d6d9df" font-size="10">Sugar exports</text>
  <text x="238" y="178" fill="#d6d9df" font-size="10">prohibited</text>
  <text x="238" y="194" fill="#8b909b" font-size="9">until 30 September</text>

  <circle cx="430" cy="112" r="8" fill="#f5b13d"/>
  <text x="394" y="142" fill="#f5b13d" font-size="11" font-weight="700">28 JUL</text>
  <text x="394" y="162" fill="#d6d9df" font-size="10">Stock limits</text>
  <text x="394" y="178" fill="#d6d9df" font-size="10">for dealers</text>
  <text x="394" y="194" fill="#8b909b" font-size="9">until 30 November</text>

  <circle cx="605" cy="112" r="8" fill="#7aa2f7"/>
  <text x="562" y="142" fill="#7aa2f7" font-size="11" font-weight="700">10-18 AUG</text>
  <text x="562" y="162" fill="#d6d9df" font-size="10">Less cane</text>
  <text x="562" y="178" fill="#d6d9df" font-size="10">for ethanol?</text>
  <text x="562" y="194" fill="#d6d9df" font-size="10">Sugar imports?</text>

  <rect x="40" y="246" width="640" height="116" rx="5" fill="#15171c"/>
  <text x="56" y="272" fill="#f5f6f8" font-size="12" font-weight="700">What this timeline establishes</text>
  <text x="56" y="296" fill="#d6d9df" font-size="10">Perceptions of India's sugar balance deteriorated sharply during the season.</text>
  <text x="56" y="316" fill="#d6d9df" font-size="10">It does not show that ethanol alone caused the squeeze.</text>
  <text x="56" y="336" fill="#d6d9df" font-size="10">The August measures are still reported options, not final decisions.</text>

  <text x="32" y="404" fill="#8b909b" font-size="9">SOURCES: PIB/DFPD, DGFT Notification 16/2026-27, Reuters 10 and 18 August 2026.</text>
</svg>
<figcaption>The reversal is striking: in February the government was still seeking more exports. In August it is examining ways to put more sugar back into the domestic market.</figcaption>
</figure>
...
The [Department of Food and Public Distribution](https://dfpd.gov.in/directorate-of-sugar/en) publishes official sugar-equivalent diversion figures:
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 455" role="img" aria-label="Sugar equivalent diverted to ethanol in India and diversification of ethanol feedstocks" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="455" fill="#0c0d10"/>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Sugar in the fuel tank: variable, not fixed</text>
  <text x="32" y="60" fill="#8b909b" font-size="11">Sugar equivalent diverted to ethanol, million tonnes.</text>
  ...
  <text x="377" y="140" text-anchor="middle" fill="#5eead4" font-size="11" font-weight="700">2.4 to 3.0</text>
  <text x="377" y="154" text-anchor="middle" fill="#8b909b" font-size="8">estimate</text>
  <text x="377" y="292" text-anchor="middle" fill="#d6d9df" font-size="10">2025-26</text>

  <line x1="450" y1="92" x2="450" y2="314" stroke="#2a2c33"/>
  <text x="478" y="112" fill="#d6d9df" font-size="11" font-weight="700">E20 no longer depends only on cane</text>
  <text x="478" y="142" fill="#5eead4" font-size="23" font-weight="700">20%</text>
  <text x="478" y="160" fill="#8b909b" font-size="9">blend reached in 2025-26</text>
  <text x="478" y="196" fill="#f5b13d" font-size="20" font-weight="700">35.96%</text>
  <text x="478" y="214" fill="#8b909b" font-size="9">maize share of ethanol, 2025-26</text>
  <text x="478" y="248" fill="#7aa2f7" font-size="20" font-weight="700">24.64%</text>
  <text x="478" y="266" fill="#8b909b" font-size="9">FCI rice share of ethanol, 2025-26</text>
  <text x="478" y="300" fill="#d6d9df" font-size="9">The rest includes cane and other</text>
  <text x="478" y="314" fill="#d6d9df" font-size="9">approved feedstocks.</text>

  <rect x="38" y="338" width="642" height="72" rx="4" fill="#15171c"/>
  <text x="54" y="360" fill="#f5f6f8" font-size="11" font-weight="700">Consequence</text>
  <text x="54" y="382" fill="#d6d9df" font-size="10">Less cane ethanol does not necessarily mean abandoning E20.</text>
  <text x="54" y="400" fill="#d6d9df" font-size="10">Government can shift part of the burden toward maize and rice.</text>

  <text x="32" y="440" fill="#8b909b" font-size="9">SOURCES: DFPD, PIB 31 July 2026, Reuters, NFCSF. 2025-26 remains an estimate.</text>
</svg>
<figcaption>The E20 programme has diversified. Cane remains important, but rising maize and rice use gives New Delhi room to preserve the 20% blend while returning more sucrose to the food market.</figcaption>
</figure>
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 400" role="img" aria-label="Collapse in Indian sugar exports since the 2021-22 season" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="400" fill="#0c0d10"/>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">A major global supplier has almost disappeared</text>
  <text x="32" y="60" fill="#8b909b" font-size="11">Indian sugar exports, million tonnes.</text>
  ...
  <text x="80" y="363" fill="#d6d9df" font-size="10">2025-26: partial quota, then export prohibition from 13 May.</text>

  <text x="32" y="392" fill="#8b909b" font-size="9">SOURCE: Department of Food and Public Distribution, Government of India.</text>
</svg>
<figcaption>India used to be a swing supplier capable of changing the global balance quickly. Its withdrawal leaves the market more dependent on Brazil and Thailand.</figcaption>
</figure>
...
- [Department of Food and Public Distribution, Directorate of Sugar, sugar policy and ethanol diversion history](https://dfpd.gov.in/directorate-of-sugar/en)
- [PIB, Ethanol Blending in India, 5 July 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2281287&lang=1&reg=3)
- [PIB, India's ethanol blended petrol programme balances food security, farmer welfare and energy security, 31 July 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2292225&lang=1&reg=48)
- [PIB, sugar dealer stock limits, 28 July 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2290498&lang=1&reg=3)
- [PIB, rainfall deficit, 22 July 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2287606&lang=1&reg=17)
- [PIB, El Niño impact on agriculture in Maharashtra, 21 July 2026](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2287315&lang=1&reg=1)
- [Indian Parliament, Lok Sabha Question 3890, 11 August 2026](https://sansad.in/getFile/lsapps/loksabhaquestions/annex/188/AU3890_pJwfqs.pdf)
- [NOAA Climate Prediction Center, ENSO Diagnostic Discussion, 9 July 2026](https://www.cpc.ncep.noaa.gov/products/analysis_monitoring/enso_advisory/ensodisc.html)
- [Conab, first 2026-27 Brazilian sugarcane crop survey, 28 April 2026](https://cast.conab.gov.br/post/2026-04-28_1_lev_cana_1/)
...
- [Reuters, 10 August 2026, India considers curbing cane use for ethanol](https://www.reuters.com/world/india/india-considers-curbing-use-cane-ethanol-tame-record-high-sugar-market-2026-08-10/)
- [Reuters, 18 August 2026, India considers limited sugar imports](https://www.reuters.com/world/india/india-considers-limited-duty-free-sugar-imports-ease-record-prices-sources-say-2026-08-18/)
- [Reuters, 18 August 2026, tropical commodities and El Niño exposure](https://www.reuters.com/business/environment/why-super-el-nio-leaves-tropical-commodities-acutely-exposed-2026-08-18/)
- [Reuters, 22 June 2026, tightening Indian sugar balance](https://www.reuters.com/world/china/india-likely-wont-export-sugar-years-el-nino-ethanol-squeeze-supply-2026-06-22/)
- [Reuters, 18 December 2025, expected surplus and ethanol diversion](https://www.reuters.com/world/india/india-tackle-sugar-surplus-with-higher-exports-ethanol-diversion-2025-12-18/)
