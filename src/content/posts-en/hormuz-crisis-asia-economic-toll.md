---
title: "The Hormuz crisis: Asia's bill for an energy shock, at the hour of the truce"
description: "A quantified, sourced assessment of the effects of the Strait of Hormuz blockade on Asia, from India to Japan: revised growth, imported inflation, industrial shortages, food threat. As the 17 June MoU begins a fragile reopening, the cumulative bill stays heavy and will take months to absorb."
pubDate: 2026-07-14T15:40:00+02:00
updatedDate: 2026-07-14T15:40:00+02:00
tags: ["geopolitics", "energy", "asia", "macro", "oil", "inflation"]
draft: false
sourceArticle: "crise-ormuz-asie-impacts-economiques"
sourceUpdatedDate: 2026-06-21
---
...
The sequence is now documented. The war launched on 28 February 2026 led Iran to close the strait in early March, followed by a US blockade of Iranian ports from April to late May. The [conflict](/en/analysis/the-2026-iran-war-economic-political-earthquake/) was suspended by a memorandum of understanding signed on 17 June at the Palace of Versailles, which implies [a reopening of the strait](/en/analysis/hormuz-reopens-three-oil-scenarios/) and the lifting of the blockade. Commercial traffic recovered on 18 and 19 June, before Tehran announced a new closure on 20 June, disputed by Washington. The truce is therefore real but precarious, and the bill analysed below is largely cumulative: it does not vanish with the signing.
...
<svg viewBox="0 0 720 360" role="img" aria-label="Revisions of 2026 forecasts for Asia" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect x="0" y="0" width="720" height="360" fill="#0c0d10"/>
  <text x="32" y="30" fill="#f5f6f8" font-size="13">GROWTH DOWN, INFLATION UP (ASIA-PACIFIC)</text>
  <text x="32" y="48" fill="#8b909b" font-size="11">ADB forecasts, special update of 29 April 2026</text>
  ...
  <circle cx="498" cy="44" r="5" fill="#8b909b"/><text x="508" y="48" fill="#8b909b" font-size="10">before</text>
  <circle cx="566" cy="44" r="5" fill="#5eead4"/><text x="576" y="48" fill="#8b909b" font-size="10">after</text>
  <text x="32" y="96" fill="#f5f6f8" font-size="11.5">Asia growth 2026</text>
  ...
  <text x="32" y="146" fill="#f5f6f8" font-size="11.5">Asia growth 2027</text>
  ...
  <text x="32" y="196" fill="#f5f6f8" font-size="11.5">Asia inflation 2026</text>
  ...
  <text x="48" y="288" fill="#8b909b" font-size="11">World Bank · energy prices 2026</text>
  <text x="48" y="306" fill="#f5b13d" font-size="15">+24% · highest since the invasion of Ukraine</text>
  <text x="32" y="344" fill="#8b909b" font-size="10.5">The IMF also lowers world growth to 3.1% in 2026 (inflation 4.4%).</text>
</svg>
<figcaption>Revisions of 2026 forecasts for Asia. Sources: Asian Development Bank, special update of 29 April 2026; World Bank, Commodity Markets Outlook (28 April 2026); IMF, World Economic Outlook (April 2026) for the world figure. Growth and inflation are annual rates; the change in energy prices is a change over the year.</figcaption>
</figure>

## Asian industry under the naphtha shock

Beyond crude, it is the Asian industrial apparatus that was disrupted. The most emblematic rupture concerns naphtha, an oil derivative present in a dizzying range of products, from plastic films to industrial inks and medical devices. Japan and South Korea depend heavily on naphtha imported from Qatar and Kuwait, whose exports were hindered by the blockage of the [Strait of Hormuz](/en/analysis/strait-of-hormuz-situation-april-2026/).
...
The shockwave will remain tangible even after the signing: fuel shortages, petrochemical chains under strain, heavier food baskets. The World Bank and the IMF say it plainly, most of the damage is already absorbed and will take months to dissipate, assuming the truce holds. And [Iranian leverage over the strait](/en/analysis/iran-hormuz-tolls-usdt-tron-ofac/) remains intact, as the 20 June closure announcement recalled. For Asia, more than 80% dependent on this corridor for its energy, the lesson is less an immediate threat than a structural vulnerability now quantified, and impossible to ignore.
