...
seoTitle: "Nvidia data center bonds: how COL4 recycled $525m | l0g"
description: "COL4 installed Nvidia clusters, then backed $525m of secured notes. Follow how data-center contracts refinance buildings without making GPUs collateral."
pubDate: 2026-08-11T16:00:00+02:00
updatedDate: 2026-08-11T16:00:00+02:00
sourceArticle: "nvidia-du-gpu-a-l-obligation-data-center"
sourceUpdatedDate: 2026-08-11T16:00:00+02:00
tags: ["nvidia", "artificial intelligence", "data centers", "securitization", "private credit", "investigation"]
draft: false
---
...
Forty-eight days later, Cologix announced a second transaction involving the same building. This time, the subject was finance rather than computing performance: [COL4 backed $525 million of secured notes](https://cologix.com/news/cologix-closes-525-million-usd-asset-backed-securitization-to-support-ai-infrastructure-interconnection-and-growth/), structured with a five-year fixed term.
...
A data center does not normally move straight from a building permit into a bond fund. The [Structured Finance Association](https://structuredfinance.org/wp-content/uploads/2026/07/SFA-Research-Corner_How-Data-Center-ABS-and-CMBS-Fit-in-a-Broader-Financing-Ecosystem.pdf) describes a succession of funding sources suited to different phases: construction loans, project finance, corporate debt, private credit and specialist equipment finance, followed by ABS or CMBS once the asset is stabilised.

<div style="max-width:720px;margin:2rem auto;overflow:hidden">
<svg viewBox="0 0 480 820" width="100%" role="img" aria-labelledby="cycle-title-en cycle-desc-en" style="display:block;width:100%;height:auto;overflow:hidden">
  <title id="cycle-title-en">The seven stages of data center capital recycling</title>
  <desc id="cycle-desc-en">From initial equity funding to debt repayment and the financing of new projects.</desc>
  <defs>
    <linearGradient id="cycle-bg-en" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#0b1724" />
      <stop offset="100%" stop-color="#101f32" />
    </linearGradient>
    <marker id="cycle-arrow-en" markerWidth="8" markerHeight="8" refX="4" refY="4" orient="auto">
      <path d="M0,0 L8,4 L0,8 Z" fill="#56d9c6" />
    </marker>
  </defs>
  <rect x="1" y="1" width="478" height="818" rx="18" fill="url(#cycle-bg-en)" stroke="#29445f" stroke-width="2" />
  <text x="24" y="34" fill="#f4f7fb" font-size="19" font-weight="700">From project to recycled capital</text>
  <text x="24" y="55" fill="#9fb5ca" font-size="12">A typical cycle for an operationally mature asset</text>
  ...
  <g font-family="system-ui, sans-serif">
    <g transform="translate(20 76)">
      ...
      <text x="62" y="26" fill="#ffffff" font-size="16" font-weight="700">Equity</text>
      <text x="62" y="47" fill="#c4d4e2" font-size="13">Land, permits and engineering</text>
      <text x="62" y="64" fill="#c4d4e2" font-size="13">plus power reservations</text>
    </g>
    <path d="M240 151 V169" stroke="#56d9c6" stroke-width="3" marker-end="url(#cycle-arrow-en)" />
    <g transform="translate(20 176)">
      ...
      <text x="62" y="26" fill="#ffffff" font-size="16" font-weight="700">Construction debt</text>
      <text x="62" y="47" fill="#c4d4e2" font-size="13">Building, substation and cooling</text>
      <text x="62" y="64" fill="#c4d4e2" font-size="13">plus connection to the grid</text>
    </g>
    <path d="M240 251 V269" stroke="#56d9c6" stroke-width="3" marker-end="url(#cycle-arrow-en)" />
    <g transform="translate(20 276)">
      ...
      <text x="62" y="26" fill="#ffffff" font-size="16" font-weight="700">Equipment finance</text>
      <text x="62" y="47" fill="#c4d4e2" font-size="13">Servers, GPUs, networks</text>
      <text x="62" y="64" fill="#c4d4e2" font-size="13">and storage</text>
    </g>
    <path d="M240 351 V369" stroke="#56d9c6" stroke-width="3" marker-end="url(#cycle-arrow-en)" />
    <g transform="translate(20 376)">
      ...
      <text x="62" y="26" fill="#ffffff" font-size="16" font-weight="700">Leasing</text>
      <text x="62" y="47" fill="#c4d4e2" font-size="13">Leases, service contracts</text>
      <text x="62" y="64" fill="#c4d4e2" font-size="13">and consumption commitments</text>
    </g>
    <path d="M240 451 V469" stroke="#56d9c6" stroke-width="3" marker-end="url(#cycle-arrow-en)" />
    <g transform="translate(20 476)">
      ...
      <text x="62" y="47" fill="#c4d4e2" font-size="13">Commissioning and occupancy</text>
      <text x="62" y="64" fill="#c4d4e2" font-size="13">with documented recurring income</text>
    </g>
    <path d="M240 551 V569" stroke="#56d9c6" stroke-width="3" marker-end="url(#cycle-arrow-en)" />
    <g transform="translate(20 576)">
      ...
      <text x="62" y="26" fill="#ffffff" font-size="16" font-weight="700">Bond issuance</text>
      <text x="62" y="47" fill="#c4d4e2" font-size="13">Notes backed by the facility</text>
      <text x="62" y="64" fill="#c4d4e2" font-size="13">contracts, accounts and cash flow</text>
    </g>
    <path d="M240 651 V669" stroke="#56d9c6" stroke-width="3" marker-end="url(#cycle-arrow-en)" />
    <g transform="translate(20 676)">
      ...
      <text x="62" y="26" fill="#ffffff" font-size="16" font-weight="700">Recycled capital</text>
      <text x="62" y="47" fill="#d7f3ee" font-size="13">Initial debt repaid</text>
      <text x="62" y="64" fill="#d7f3ee" font-size="13">and new developments funded</text>
    </g>
  </g>
  <text x="24" y="782" fill="#8199af" font-size="11">l0g synthesis from SFA and Latham.</text>
  <text x="24" y="798" fill="#8199af" font-size="11">Each transaction retains its own terms.</text>
</svg>
</div>
...
The [Form ABS-15G filed with the SEC on 24 June 2025](https://www.sec.gov/Archives/edgar/data/1896619/000119312525145810/d51270dabs15g.htm) identifies the issuer as **Scalelogix ABS US Issuer, LLC, Series 2025-1**. The [KPMG agreed-upon procedures report](https://www.sec.gov/Archives/edgar/data/1896619/000119312525145810/d51270dex991.htm) names Cologix and Deutsche Bank Securities, identified as the structuring agent. It covers six data center agreements intended for the collateral pool. KPMG compared attributes including tenant name, leased critical load, rent, contract dates and renewal options with documents supplied by Cologix.
...
[Switch provides a more explicit example](https://www.switch.com/switch-raises-768-million-in-latest-data-center-abs-issuance/). In April 2026, the operator raised $768 million. Net proceeds were to repay existing debt and fund general corporate purposes. The issuance added a Reno facility of about 1.4 million square feet and more than 52 MW to the collateral pool. After the transaction, the vehicle contained 11 data centers across five markets and served more than 550 customers.
...
[KBRA's methodology](https://www.kbra.com/publications/ywsVHsMw/abs-data-center-abs-global-rating-methodology?format=web) explicitly addresses ARDs, amortisation triggers, the allocation of excess cash and the possible use of property-sale proceeds. The Structured Finance Association explains that these mechanisms encourage refinancing or deleveraging when notes remain outstanding beyond the expected repayment date.
...
[DataBank 2026-1 illustrates the second model](https://www.kbra.com/publications/tGrWrdbr/kbra-assigns-preliminary-ratings-to-databank-series-2026-1?format=web). The pool contained 36 data centers, 1,757 customers and 257.6 MW of critical load. The largest customer represented only 3.9% of annualised monthly recurring revenue. Yet the weighted average remaining contract term was just two years.
...
The [first article in this investigation](/en/analysis/nvidia-the-500-billion-that-does-not-exist-yet/) showed that Nvidia's $500 billion announcement described future financing capacity combining equity, debt, co-investors, guarantees and platforms that partly existed already. The cycle described here shows how the same unit of capital can be used repeatedly.
...
Yet on [29 July 2026, SEC staff](https://www.sec.gov/rules-regulations/no-action-interpretive-exemptive-letters/division-corporation-finance-no-action/certain-data-center-securitizations-072926) agreed, for the specific facts presented, that certain direct data center issuances are not asset-backed securities under the Exchange Act. The response is a non-binding staff view, not a general Commission rule.
...
- [Cologix and Lambda, NVIDIA HGX B200 clusters deployed at COL4, 3 June 2025](https://cologix.com/news/cologix-and-lambda-launch-first-nvidia-hgx-b200-accelerated-ai-clusters-in-columbus-at-col4/)
- [Cologix, closing of $525 million of notes backed by COL4, 21 July 2025](https://cologix.com/news/cologix-closes-525-million-usd-asset-backed-securitization-to-support-ai-infrastructure-interconnection-and-growth/)
- [SEC, Scalelogix ABS US Issuer Form ABS-15G, 24 June 2025](https://www.sec.gov/Archives/edgar/data/1896619/000119312525145810/d51270dabs15g.htm)
- [SEC, KPMG agreed-upon procedures report covering six agreements, 13 June 2025](https://www.sec.gov/Archives/edgar/data/1896619/000119312525145810/d51270dex991.htm)
- [S&P Global Ratings, preliminary ratings for Scalelogix Series 2025-1, 26 June 2025](https://www.spglobal.com/ratings/en/regulatory/article/-/view/type/HTML/id/3397191)
- [Structured Finance Association, the data center financing lifecycle, 23 July 2026](https://structuredfinance.org/wp-content/uploads/2026/07/SFA-Research-Corner_How-Data-Center-ABS-and-CMBS-Fit-in-a-Broader-Financing-Ecosystem.pdf)
- [Latham & Watkins, interpretive request submitted to the SEC, 23 July 2026](https://business.cch.com/srd/dcs-interp-letter-072326080426.pdf)
- [KBRA, global data center ABS rating methodology, 9 January 2026](https://www.kbra.com/publications/ywsVHsMw/abs-data-center-abs-global-rating-methodology?format=web)
- [KBRA, DataBank Series 2026-1, 12 January 2026](https://www.kbra.com/publications/tGrWrdbr/kbra-assigns-preliminary-ratings-to-databank-series-2026-1?format=web)
- [Switch, $768 million Series 2026-1 issuance, 14 April 2026](https://www.switch.com/switch-raises-768-million-in-latest-data-center-abs-issuance/)
- [SEC staff response on certain direct data center issuances, 29 July 2026](https://www.sec.gov/rules-regulations/no-action-interpretive-exemptive-letters/division-corporation-finance-no-action/certain-data-center-securitizations-072926)
