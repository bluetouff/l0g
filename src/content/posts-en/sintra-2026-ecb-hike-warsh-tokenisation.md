...
draft: false
sourceArticle: "sintra-2026-bce-tokenisation"
sourceUpdatedDate: 2026-07-02
---
...
<text x="120" y="56" fill="#f5b13d" font-size="12">peak 4.00% (Sept 2023)</text>
<text x="500" y="252" fill="#8b909b" font-size="12">trough 2.00%</text>
<text x="636" y="205" fill="#ff4d87" font-size="12">2.25%</text>
<text x="360" y="120" fill="#8b909b" font-size="12">eight cuts (June 2024 to June 2025)</text>
<text x="20" y="290" fill="#8b909b" font-size="12">First hike since September 2023. Effective 17 June.</text>
<text x="20" y="308" fill="#8b909b" font-size="12">Source: European Central Bank, monetary policy decision of 11 June 2026.</text>
</svg>
</figure>
...
<text x="150" y="122" text-anchor="middle" fill="#8b909b" font-size="11">settlement anchor</text>
<rect x="270" y="82" width="180" height="52" rx="6" fill="none" stroke="#e7e9ee" stroke-width="1.5"/>
<text x="360" y="104" text-anchor="middle" fill="#e7e9ee" font-size="13">tokenised deposits</text>
<text x="360" y="122" text-anchor="middle" fill="#8b909b" font-size="11">means of payment</text>
<rect x="480" y="82" width="180" height="52" rx="6" fill="none" stroke="#f5b13d" stroke-width="1.5"/>
<text x="570" y="104" text-anchor="middle" fill="#f5b13d" font-size="13">tokenised assets</text>
<text x="570" y="122" text-anchor="middle" fill="#8b909b" font-size="11">e.g. government bonds</text>
<text x="20" y="192" fill="#e7e9ee" font-size="14">Atomic settlement: three layers collapse into one step</text>
...
<text x="290" y="235" text-anchor="middle" fill="#8b909b" font-size="12">clearing</text>
<rect x="380" y="210" width="140" height="40" rx="6" fill="none" stroke="#8b909b" stroke-width="1"/>
<text x="450" y="235" text-anchor="middle" fill="#8b909b" font-size="12">settlement</text>
...
<text x="628" y="235" text-anchor="middle" fill="#ff4d87" font-size="12">1 step</text>
<text x="20" y="300" fill="#8b909b" font-size="12">Final settlement in central-bank money preserves the two-tier system and the singleness of</text>
<text x="20" y="318" fill="#8b909b" font-size="12">money. Source: Ryu, Shin, Sung, Yun, "A unified ledger in practice", ECB Forum 2026; BIS (2023).</text>
</svg>
</figure>
...
<text x="48" y="106">1. burned at bank A</text>
<text x="48" y="134">2. wCBDC transferred between banks</text>
<text x="48" y="162">3. re-issued at bank B</text>
</g>
<text x="48" y="198" fill="#5eead4" font-size="13">→ always at par</text>
<text x="48" y="224" fill="#8b909b" font-size="12">liability of a single bank, settled</text>
<text x="48" y="242" fill="#8b909b" font-size="12">in central-bank money</text>
<rect x="370" y="48" width="320" height="210" rx="8" fill="none" stroke="#ff4d87" stroke-opacity="0.6" stroke-width="1.5"/>
<text x="388" y="74" fill="#ff4d87" font-size="14">Stablecoin (simple transfer)</text>
<g font-size="13" fill="#e7e9ee">
<text x="388" y="106">the token changes hands</text>
<text x="388" y="134">a claim on the issuer, not on</text>
<text x="388" y="152">the sender's bank</text>
</g>
<text x="388" y="192" fill="#ff4d87" font-size="13">→ can deviate from par</text>
<text x="388" y="224" fill="#8b909b" font-size="12">depending on the issuer's solvency</text>
<text x="388" y="242" fill="#8b909b" font-size="12">and risk appetite</text>
<text x="20" y="288" fill="#8b909b" font-size="12">Source: Garratt and Shin (2023); Hangang paper, ECB Forum 2026.</text>
</svg>
</figure>
...
The paper situates Hangang against two ECB work streams: Pontes, which links the tokenised to the existing real-time gross settlement (RTGS) infrastructure, and Appia, which aims to deliver by 2028 the blueprint for an integrated wholesale-settlement ecosystem, anchored in tokenised central-bank money. In its 11 June statement, the Governing Council indicates that the digital euro and tokenised wholesale central-bank money will strengthen Europe's "strategic autonomy". On the mechanics of settlement and collateral, see [the liquidity factory of repo](/en/analysis/repo-the-liquidity-factory/); on central-bank reserves, [de-dollarisation through gold](/en/analysis/central-banks-gold-de-dollarisation/).
