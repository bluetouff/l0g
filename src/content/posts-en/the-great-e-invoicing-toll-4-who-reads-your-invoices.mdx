...
The investigation concludes by examining [what happens when the flow fails, degrades or requires regularisation](/en/analysis/the-great-e-invoicing-toll-5-when-the-pipe-breaks/).
