...
draft: false
sourceArticle: "boom-ia-bis-fragilite-financiere"
sourceUpdatedDate: 2026-06-29
---
...
<svg viewBox="0 0 720 300" role="img" aria-label="AI-related investment compared with past investment booms, as a share of GDP" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
 <rect width="720" height="300" fill="#0c0d10"></rect>
 <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">A real boom, but not off the charts</text>
 <text x="32" y="59" fill="#8b909b" font-size="12">Rise in investment at the boom's peak, as a share of GDP. Source: BIS, bulletin 120.</text>
 <text x="40" y="104" fill="#5eead4" font-size="12">AI, United States, 2020s</text>
 <rect x="250" y="92" width="80" height="22" fill="#5eead4" opacity="0.85"></rect>
 <text x="340" y="108" fill="#d6d9df" font-size="12">~1%</text>
 <text x="40" y="142" fill="#8b909b" font-size="12">Shale, US, 2010s</text>
 <rect x="250" y="130" width="80" height="22" fill="#8b909b" opacity="0.7"></rect>
 <text x="340" y="146" fill="#d6d9df" font-size="12">~1%</text>
 <text x="40" y="180" fill="#f5b13d" font-size="12">Internet, US, 1990s</text>
 <rect x="250" y="168" width="160" height="22" fill="#f5b13d" opacity="0.8"></rect>
 <text x="420" y="184" fill="#d6d9df" font-size="12">~2%</text>
 <text x="40" y="218" fill="#8b909b" font-size="12">Real estate, Japan, 1980s</text>
 <rect x="250" y="206" width="400" height="22" fill="#ff4d87" opacity="0.65"></rect>
 <text x="36" y="262" fill="#d6d9df" font-size="12">At 1% of GDP, the AI boom is on the order of shale, half the size of the Internet</text>
 <text x="36" y="282" fill="#8b909b" font-size="12">bubble. But total IT investment, 5% of GDP, exceeds the 2000 peak.</text>
</svg>
<figcaption>Relative to GDP, AI-specific investment stays moderate against the great historical booms. The risk lies less in its size than in how it is financed. Source: BIS, bulletin 120, January 2026.</figcaption>
</figure>

## Circular financing, the blind spot

This is the passage Finneko foregrounds most, and he is right to press it. The BIS defines circular financing as an arrangement where hyperscalers take stakes in AI labs in exchange for purchase commitments, which sends capital back to investors as revenue. Added to this are leases on data centers built by third parties, take-or-pay capacity clauses, and off-balance-sheet commitments, where leverage does not vanish for all that. Our piece on [AI circular financing](/en/analysis/ai-circular-financing/) details these loops.

[Private credit](/en/glossary/credit-prive/) is at the heart of the shift. According to the BIS, direct lending by private-credit funds to AI-linked firms has gone from close to zero to more than **$200** billion, its share rising from under **1%** to nearly **8%** of the stock, with a projection of **$300 to $600** billion by 2030. Yet the spreads demanded on these loans, **6.2** points against **6.1** for other sectors, are almost identical. Lenders are therefore treating AI risk as average risk, while equity valuations assume off-the-charts returns. One of two things: either credit underestimates the risk, or equities overestimate future profits. This dissonance between debt and equity is the report's real signal. The backdrop is a private-credit market grown colossal: assets managed by these funds have risen from about **$100** billion in 2010 to more than **$2,200** billion today. The BIS March 2026 Quarterly Review speaks of "shadow leverage" for commitments economically akin to debt but largely held off balance sheet, and notes gross hyperscaler bond issuance topping **$100** billion in 2025, at long maturities matched to the assets' lifespan. For the mechanics of private credit, see our guide on [reading private credit](/en/guides/read-private-credit-risk/).
...
<figure class="infographic">
<svg viewBox="0 0 720 290" role="img" aria-label="Private credit to AI-linked firms: outstanding amount and share of the total" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
 <rect width="720" height="290" fill="#0c0d10"></rect>
 <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">The shift into private debt</text>
 <text x="32" y="59" fill="#8b909b" font-size="12">Private credit to AI-linked firms, in billions of dollars. Source: BIS.</text>
 <text x="40" y="104" fill="#8b909b" font-size="12">2010</text>
 <rect x="150" y="92" width="6" height="22" fill="#8b909b" opacity="0.7"></rect>
 <text x="170" y="108" fill="#d6d9df" font-size="12">near zero</text>
 <text x="40" y="142" fill="#5eead4" font-size="12">2025</text>
 <rect x="150" y="130" width="200" height="22" fill="#5eead4" opacity="0.85"></rect>
 <text x="360" y="146" fill="#d6d9df" font-size="12">over $200bn · nearly 8% of the stock</text>
 ...
 <text x="610" y="184" fill="#d6d9df" font-size="12">$300 to $600bn</text>
 <text x="36" y="242" fill="#d6d9df" font-size="12">AI loan spread: 6.2 points, versus 6.1 for other sectors. Credit prices</text>
 <text x="36" y="262" fill="#8b909b" font-size="12">AI as an average risk, while equities assume off-the-charts returns.</text>
</svg>
<figcaption>Private credit is becoming a major source of AI financing, but the spreads demanded do not reflect the extreme bet priced into equities. Source: BIS, bulletin 120, January 2026.</figcaption>
</figure>
...
- [BIS, *Annual Economic Report 2026*](https://www.bis.org/publ/arpdf/ar2026e.htm), 28 June 2026: chart 13, debt financing, rising CDS of AI issuers, circular financing, repricing compared with 2008.
- [BIS, press release on the 2026 annual report](https://www.bis.org/press/p260628.htm), 28 June 2026.
- [BIS, bulletin no. 120, "Financing the AI boom: from cash flows to debt" (Aldasoro, Doerr, Rees)](https://www.bis.org/publ/bisbull120.pdf), 7 January 2026: investment figures (1% and 5% of GDP, 0.4 point of growth), shift to debt, private credit, historical perspective on booms.
- [BIS, *Quarterly Review*, box on "shadow leverage"](https://www.bis.org/publ/qtrpdf/r_qt2603.pdf), March 2026.
- [IMF, *Global Financial Stability Report*, chapter 2 "The Rise and Risks of Private Credit"](https://www.imf.org/-/media/files/publications/gfsr/2024/april/english/ch2.pdf), April 2024.
- [IEA, *Energy and AI*](https://www.iea.org/reports/energy-and-ai), April 2025.
- [McKinsey, "The cost of compute: A $7 trillion race to scale data centers"](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-cost-of-compute-a-7-trillion-dollar-race-to-scale-data-centers), 28 April 2025.
...
- [Rahil Solanki, "The AI Circular Economy: Systemic Risk, Vendor Financing, and the Keystone Problem", SSRN](https://ssrn.com/abstract=6672478), April 2026.
...
- Starting point: [Finneko thread (@finneko_prgrm)](https://x.com/finneko_prgrm/status/2071477896980418747), 29 June 2026.
