...
draft: false
sourceArticle: "financement-circulaire-ia"
...
<svg viewBox="0 0 720 330" role="img" aria-label="The loop of AI circular financing between chipmaker, lab and cloud providers" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="330" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">The lap of the AI dollar</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">Capital invested at the top comes back as orders at the bottom. Announced amounts.</text>
  <rect x="280" y="86" width="160" height="56" rx="8" fill="none" stroke="#5eead4" stroke-width="1.5"></rect>
  <text x="360" y="112" fill="#f5f6f8" font-size="13" text-anchor="middle">Chipmaker</text>
  ...
  <text x="150" y="226" fill="#f5f6f8" font-size="13" text-anchor="middle">AI lab</text>
  ...
  <text x="570" y="220" fill="#f5f6f8" font-size="13" text-anchor="middle">Cloud providers</text>
  ...
  <text x="188" y="160" fill="#5eead4" font-size="11">invests up to $100bn</text>
  <line x1="240" y1="232" x2="478" y2="232" stroke="#ff4d87" stroke-width="1.6" marker-end="url(#l2)"></line>
  <text x="360" y="224" fill="#ff4d87" font-size="11" text-anchor="middle">leases compute, $300bn Oracle</text>
  <line x1="560" y1="198" x2="430" y2="128" stroke="#f5b13d" stroke-width="1.6" marker-end="url(#l3)"></line>
  <text x="558" y="160" fill="#f5b13d" font-size="11">buy the chips</text>
  <text x="360" y="300" fill="#d6d9df" font-size="12" text-anchor="middle">The dollar loops among a handful of interconnected players.</text>
  <defs>
...
<figcaption>The maker invests in the lab, which leases compute from the cloud providers, which buy the maker's chips. Publicly announced commitment amounts. Sources: Reuters, Bloomberg, company statements.</figcaption>
</figure>
...
<figure class="infographic">
<svg viewBox="0 0 720 280" role="img" aria-label="OpenAI compute commitments compared with its revenue" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="280" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Commitments versus revenue, OpenAI</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">Cumulative compute commitments over the decade, versus annual revenue. $bn.</text>
  <text x="32" y="108" fill="#ff4d87" font-size="12">COMPUTE COMMITMENTS</text>
  <rect x="32" y="118" width="640" height="34" fill="#ff4d87" opacity="0.85"></rect>
  <text x="42" y="140" fill="#0c0d10" font-size="13" font-weight="700">~$1,400bn</text>
  <text x="32" y="190" fill="#5eead4" font-size="12">REVENUE (early 2026)</text>
  <rect x="32" y="200" width="9" height="34" fill="#5eead4" opacity="0.9"></rect>
  <text x="50" y="222" fill="#d6d9df" font-size="13">~$13bn</text>
  <text x="32" y="266" fill="#8b909b" font-size="11">The green bar, to scale, is under 1% of the pink one.</text>
</svg>
<figcaption>Close to $1.4 trillion of cumulative compute commitments against revenue on the order of $13 billion in early 2026. The green bar, to scale, is almost invisible. Sources: commitments announced by the companies, press estimates (Reuters, Bloomberg).</figcaption>
</figure>
