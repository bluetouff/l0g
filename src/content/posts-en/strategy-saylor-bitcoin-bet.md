...
draft: false
sourceArticle: "strategy-pari-bitcoin-saylor"
sourceUpdatedDate: 2026-06-30
---
...
<svg viewBox="0 0 720 300" role="img" aria-label="Strategy's circular financing mechanism through the premium to net asset value" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="300" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">The machine, as long as the premium exists</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">The accretive cycle works above net asset value (mNAV above 1).</text>
  <rect x="48" y="96" width="160" height="60" rx="8" fill="none" stroke="#5eead4" stroke-width="1.5"></rect>
  <text x="128" y="122" fill="#f5f6f8" font-size="12" text-anchor="middle">Premium to NAV</text>
  ...
  <text x="360" y="122" fill="#f5f6f8" font-size="12" text-anchor="middle">Share issuance</text>
  <text x="360" y="140" fill="#f5b13d" font-size="11" text-anchor="middle">and debt</text>
  <rect x="512" y="96" width="160" height="60" rx="8" fill="none" stroke="#5eead4" stroke-width="1.5"></rect>
  <text x="592" y="122" fill="#f5f6f8" font-size="12" text-anchor="middle">Bitcoin purchase</text>
  <text x="592" y="140" fill="#5eead4" font-size="11" text-anchor="middle">spot</text>
  <rect x="280" y="206" width="160" height="60" rx="8" fill="none" stroke="#5eead4" stroke-width="1.5"></rect>
  <text x="360" y="232" fill="#f5f6f8" font-size="12" text-anchor="middle">Bitcoin per share</text>
  <text x="360" y="250" fill="#5eead4" font-size="11" text-anchor="middle">rising (BTC Yield)</text>
  ...
  <text x="40" y="292" fill="#ff4d87" font-size="11">Below 1.0, the cycle reverses: issuing shares destroys value per share.</text>
</svg>
<figcaption>Above net asset value, each share issuance raises bitcoin per share, which supports the premium and allows issuing again. Below 1.0, the same mechanism reverses and becomes dilutive. Source: Strategy 8-K filings, capital-allocation framework.</figcaption>
</figure>
...
<figure class="infographic" style="padding-bottom:1.75rem">
<svg viewBox="0 0 720 330" role="img" aria-label="Priority order of Strategy's creditors and shareholders" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;font-family:ui-monospace,monospace">
  <rect width="720" height="330" fill="#0c0d10"></rect>
  <text x="32" y="38" fill="#f5f6f8" font-size="17" font-weight="700">Who gets paid first</text>
  <text x="32" y="59" fill="#8b909b" font-size="12">Priority order, from most senior to most junior. The common shareholder brings up the rear.</text>
  <rect x="120" y="80" width="480" height="30" fill="#5eead4" opacity="0.85"></rect>
  <text x="360" y="100" fill="#0c0d10" font-size="12" font-weight="700" text-anchor="middle">Convertible debt · more than $7bn</text>
  <rect x="150" y="118" width="420" height="28" fill="#f5b13d" opacity="0.85"></rect>
  <text x="360" y="137" fill="#0c0d10" font-size="11.5" font-weight="700" text-anchor="middle">Senior preferreds · STRF, STRE · 10%</text>
