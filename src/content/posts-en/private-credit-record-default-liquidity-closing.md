...
draft: false
sourceArticle: "credit-prive-juin-2026-defaut-record-gating"
sourceUpdatedDate: 2026-06-17
---
...
<figure>
<svg viewBox="0 0 720 312" width="100%" role="img" aria-label="Comparison of default rates depending on the perimeter chosen" xmlns="http://www.w3.org/2000/svg" font-family="'JetBrains Mono Variable', ui-monospace, monospace">
<text x="40" y="26" fill="#5eead4" font-size="17">Default, by what you agree to count in it (May 2026)</text>
<g font-size="14">
<text x="40" y="62" fill="#e7e9ee">Payment default, leveraged loans (by issuer)</text>
<rect x="40" y="70" width="91" height="16" fill="#5eead4"/>
<text x="139" y="83" fill="#e7e9ee">1.42%</text>
<text x="40" y="118" fill="#e7e9ee">Dual-track rate, with liability management (LME)</text>
<rect x="40" y="126" width="199" height="16" fill="#5eead4"/>
<text x="247" y="139" fill="#e7e9ee">3.11%</text>
<text x="40" y="174" fill="#e7e9ee">Private credit, broad Fitch index (PCDR)</text>
<rect x="40" y="182" width="384" height="16" fill="#ff4d87"/>
<text x="432" y="195" fill="#e7e9ee">6.0%</text>
<text x="40" y="230" fill="#e7e9ee">Private credit, large LBO borrowers (PMR)</text>
<rect x="40" y="238" width="608" height="16" fill="#ff4d87"/>
<text x="40" y="278" fill="#8b909b" font-size="12">In cyan, what the visible counter shows. In pink, what appears when you widen the perimeter.</text>
<text x="40" y="296" fill="#8b909b" font-size="12">Sources: Fitch Ratings (May 2026); Morningstar LSTA / PitchBook LCD (as of 31 May 2026).</text>
</g>
</svg>
</figure>
...
<figure>
<svg viewBox="0 0 720 260" width="100%" role="img" aria-label="Evolution of the share of PIK loans between 2022 and end-2025" xmlns="http://www.w3.org/2000/svg" font-family="'JetBrains Mono Variable', ui-monospace, monospace">
<text x="40" y="26" fill="#5eead4" font-size="17">The normalisation of interest deferral (PIK)</text>
<g font-size="14">
<text x="40" y="62" fill="#e7e9ee">PIK, market share, early 2022</text>
<rect x="40" y="70" width="120" height="16" fill="#8b909b"/>
<text x="168" y="83" fill="#e7e9ee">5%</text>
<text x="40" y="106" fill="#e7e9ee">PIK, market share, end 2025</text>
<rect x="40" y="114" width="264" height="16" fill="#ff4d87"/>
<text x="312" y="127" fill="#e7e9ee">11%</text>
<text x="40" y="156" fill="#e7e9ee">"Bad PIK" (cash converted to PIK), early 2022</text>
<rect x="40" y="164" width="48" height="16" fill="#8b909b"/>
<text x="96" y="177" fill="#e7e9ee">2%</text>
<text x="40" y="200" fill="#e7e9ee">"Bad PIK" (cash converted to PIK), end 2025</text>
<rect x="40" y="208" width="154" height="16" fill="#ff4d87"/>
<text x="202" y="221" fill="#e7e9ee">6.4%</text>
<text x="40" y="248" fill="#8b909b" font-size="12">Source: Lincoln International (values about a third of US private-credit portfolios).</text>
</g>
</svg>
</figure>
...
<figure>
<svg viewBox="0 0 720 280" width="100%" role="img" aria-label="Redemption requests on the main semi-liquid funds compared to the 5 percent cap" xmlns="http://www.w3.org/2000/svg" font-family="'JetBrains Mono Variable', ui-monospace, monospace">
<text x="40" y="26" fill="#5eead4" font-size="17">Redemption requests vs 5% cap (2026)</text>
<g font-size="14">
<line x1="240" y1="44" x2="240" y2="214" stroke="#5eead4" stroke-width="1.5" stroke-dasharray="4 4"/>
<text x="246" y="56" fill="#5eead4" font-size="12">5% cap</text>
<text x="40" y="78" fill="#e7e9ee">Cliffwater (flagship fund)</text>
<rect x="40" y="86" width="560" height="16" fill="#ff4d87"/>
<text x="608" y="99" fill="#e7e9ee">14%</text>
<text x="40" y="122" fill="#e7e9ee">HLEND (BlackRock / HPS), Q2</text>
...
<text x="40" y="210" fill="#e7e9ee">Blackstone (BCRED), Q1</text>
<rect x="40" y="218" width="316" height="16" fill="#f5b13d"/>
<text x="364" y="231" fill="#e7e9ee">7.9%</text>
<text x="40" y="258" fill="#8b909b" font-size="12">Redemption requests, not actual redemptions (capped at 5%). Q1 and Q2 2026 mixed.</text>
<text x="40" y="276" fill="#8b909b" font-size="12">Sources: Reuters, Financial Times, Bloomberg, ZeroHedge (March to June 2026).</text>
</g>
</svg>
</figure>
