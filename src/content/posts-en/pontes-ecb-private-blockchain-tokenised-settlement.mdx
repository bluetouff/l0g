...
sourceUpdatedDate: 2026-08-29T09:00:00+02:00
...
The weak point in tokenised settlement is not necessarily the hash. It can be the contract that gives the hash legal effect. The [RealT liquidation case](/en/analysis/realt-liquidation-token-without-the-deed/) provides a concrete retail example: tokens had been issued while the underlying deeds remained with the seller.
