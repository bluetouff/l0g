...
---
*At the close of this series on the plumbing of the dollar, one mechanism remains to be exposed, the one hiding beneath all the others. [Repo](/en/analysis/repo-the-liquidity-factory/), the basis trade, [shadow banking](/en/analysis/shadow-banking-nonbank-intermediation/), [eurodollars](/en/analysis/eurodollars-the-offshore-dollar/) and the [cross-currency basis](/en/analysis/the-cross-currency-basis/) all rest on one idea: a security pledged as collateral does not sleep, it immediately goes off to back another loan. This reuse, rehypothecation, turns a finite stock of Treasury bonds into a far larger volume of funding. Collateral is the oil of the financial engine, and its circulation is the keystone of the whole edifice.*
