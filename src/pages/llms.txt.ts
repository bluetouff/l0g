...
export const GET: APIRoute = async () => {
  ...
  lines.push(
    `- [Agent Surface v1.7.0](${SITE}/donnees/agents/): surface M2M pour agents IA : manifeste, OpenAPI, evidence graph, NDJSON, claims sourcées, dates séparées, retrievedAt, sources, fraîcheur, intégrité attestée, revue humaine et changefeed versionné.`
  );
  lines.push(
